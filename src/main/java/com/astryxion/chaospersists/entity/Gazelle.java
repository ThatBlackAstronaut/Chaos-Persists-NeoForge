...
extends EntityTameable {
    ...
    private boolean scan_it(int x, int y, int z, int dx, int dy, int dz) {
        ...
        for (i = - dy; i <= dy; ++i) {
            for (j = - dz; j <= dz; ++j) {
                ...
                if ((bid == ChaosPersists.MyStrawberryPlant || bid == Blocks.POTATOES || bid == Blocks.CARROTS || bid == Blocks.TALLGRASS || bid == Blocks.DOUBLE_PLANT) && (d = dx * dx + j * j + i * i) < this.closest) {
                    this.closest = d;
                    this.tx = x + dx;
                    this.ty = y + i;
                    this.tz = z + j;
                ...
                if ((bid = this.world.getBlockState(new net.minecraft.util.math.BlockPos(x - dx, y + i, z + j)).getBlock()) != ChaosPersists.MyStrawberryPlant && bid != Blocks.POTATOES && bid != Blocks.CARROTS && bid != Blocks.TALLGRASS && bid != Blocks.DOUBLE_PLANT || (d = dx * dx + j * j + i * i) >= this.closest) continue;
                this.closest = d;
                this.tx = x - dx;
                this.ty = y + i;
                this.tz = z + j;
        ...
        for (i = - dx; i <= dx; ++i) {
            for (j = - dz; j <= dz; ++j) {
                ...
                if ((bid == ChaosPersists.MyStrawberryPlant || bid == Blocks.POTATOES || bid == Blocks.CARROTS || bid == Blocks.TALLGRASS || bid == Blocks.DOUBLE_PLANT) && (d = dy * dy + j * j + i * i) < this.closest) {
                    this.closest = d;
                    this.tx = x + i;
                    this.ty = y + dy;
                    this.tz = z + j;
                ...
                if ((bid = this.world.getBlockState(new net.minecraft.util.math.BlockPos(x + i, y - dy, z + j)).getBlock()) != ChaosPersists.MyStrawberryPlant && bid != Blocks.POTATOES && bid != Blocks.CARROTS && bid != Blocks.TALLGRASS && bid != Blocks.DOUBLE_PLANT || (d = dy * dy + j * j + i * i) >= this.closest) continue;
                this.closest = d;
                this.tx = x + i;
                this.ty = y - dy;
                this.tz = z + j;
        ...
        for (i = - dx; i <= dx; ++i) {
            for (j = - dy; j <= dy; ++j) {
                ...
                if ((bid == ChaosPersists.MyStrawberryPlant || bid == Blocks.POTATOES || bid == Blocks.CARROTS || bid == Blocks.TALLGRASS || bid == Blocks.DOUBLE_PLANT) && (d = dz * dz + j * j + i * i) < this.closest) {
                    this.closest = d;
                    this.tx = x + i;
                    this.ty = y + j;
                    this.tz = z + dz;
                ...
                if ((bid = this.world.getBlockState(new net.minecraft.util.math.BlockPos(x + i, y + j, z - dz)).getBlock()) != ChaosPersists.MyStrawberryPlant && bid != Blocks.POTATOES && bid != Blocks.CARROTS && bid != Blocks.TALLGRASS && bid != Blocks.DOUBLE_PLANT || (d = dz * dz + j * j + i * i) >= this.closest) continue;
                this.closest = d;
                this.tx = x + i;
                this.ty = y + j;
                this.tz = z - dz;
    ...
    protected void fall(float par1) {
        ...
        if (i > 0.0f) {
            if (i > 3.0f) {
                this.playSound(net.minecraft.util.SoundEvent.REGISTRY.getObject(new net.minecraft.util.ResourceLocation("minecraft", "entity.generic.big_fall")), 1.0f, 1.0f);
            } else {
                this.playSound(net.minecraft.util.SoundEvent.REGISTRY.getObject(new net.minecraft.util.ResourceLocation("minecraft", "entity.generic.small_fall")), 1.0f, 1.0f);
            }
            if (i > 2.0f) {
                i = 2.0f;
            }
    ...
    protected void updateAITasks() {
        ...
        if (!this.isSitting()) {
            Gazelle buddy;
            if ((this.world.rand.nextInt(30) == 0 && this.getGazelleHealth() < this.mygetMaxHealth() || this.world.rand.nextInt(750) == 1) && ChaosPersists.PlayNicely == 0) {
                this.closest = 99999;
                this.tz = 0;
                this.ty = 0;
                this.tx = 0;
                ...
                if (this.closest < 99999) {
                    ...
                    if (this.closest < 12) {
                        ...
                        this.heal(1.0f);
                        this.playSound(net.minecraft.util.SoundEvent.REGISTRY.getObject(new net.minecraft.util.ResourceLocation("minecraft", "entity.player.burp")), 1.0f, this.world.rand.nextFloat() * 0.2f + 0.9f);
                    }
                }
            }
