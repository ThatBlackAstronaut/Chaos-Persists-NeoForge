...
extends EntityMob {
    private static final DataParameter<Byte> ATTACKING = EntityDataManager.createKey(Hammerhead.class, DataSerializers.BYTE);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue((double)ChaosPersists.Hammerhead_stats.attack);
    }
    ...
    protected SoundEvent getAmbientSound() {
        if (this.rand.nextInt(3) == 0) {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("chaospersists", "hammerhead_living"));
        }
        return null;
    }
    ...
    protected SoundEvent getDeathSound() {
        return SoundEvent.REGISTRY.getObject(new ResourceLocation("chaospersists", "hammerhead_death"));
    }
    ...
    private void dropItemRand(Item index, int par1) {
        EntityItem var3 = new EntityItem(this.world, this.posX + (double)ChaosPersists.ChaosRand.nextInt(5) - (double)ChaosPersists.ChaosRand.nextInt(5), this.posY + 2.0, this.posZ + (double)ChaosPersists.ChaosRand.nextInt(5) - (double)ChaosPersists.ChaosRand.nextInt(5), new ItemStack(index, par1, 0));
    ...
    protected void dropFewItems(boolean par1, int par2) {
        ...
        for (var4 = 0; var4 < 4; ++var4) {
            this.dropItemRand(Item.getItemFromBlock((Block)ChaosPersists.CreeperRepellent), 1);
        }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.world.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expand(18.0, 9.0, 18.0));
