...
extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue((double)ChaosPersists.Brutalfly_stats.attack);
    }
    ...
    protected SoundEvent getDeathSound() {
        return SoundEvent.REGISTRY.getObject(new ResourceLocation("entity.generic.explode"));
    }
    ...
    protected void updateAITasks() {
        ...
        if (this.stuck_count > 30 || this.world.rand.nextInt(200) == 0 || this.currentFlightTarget.distanceSq(this.posX, this.posY, this.posZ) < 9.0) {
            Block bid;
            int down = 0;
            int dist = 20;
            for (int i = -5; i <= 5; i += 5) {
            ...
            while (bid != Blocks.AIR && keep_trying != 0) {
                ...
                newx *= xdir;
                newz *= zdir;
                this.currentFlightTarget = new BlockPos((int)this.posX + newx, (int)this.posY + this.world.rand.nextInt(7) - 1 - down, (int)this.posZ + newz);
        ...
        if (this.world.rand.nextInt(6) == 0) {
            ...
            target = (EntityPlayer)this.world.findNearestEntityWithinAABB(EntityPlayer.class, this.getEntityBoundingBox().expand(30.0, 20.0, 30.0), (Entity)this);
            if (target != null) {
    ...
    protected void dropFewItems(boolean par1, int par2) {
        ...
        for (int i = 0; i < 20; ++i) {
            ...
            this.world.spawnParticle(EnumParticleTypes.EXPLOSION_LARGE, this.posX + (double)var1, this.posY + 2.0 + (double)var2, this.posZ + (double)var3, 0.0, 0.0, 0.0);
        }
        for (var4 = 0; var4 < 53; ++var4) {
            this.dropItemRand(Items.GOLD_NUGGET, 1);
        }
        for (var4 = 0; var4 < 20; ++var4) {
            Brutalfly.spawnCreature((World)this.world, (String)"Butterfly", (double)(this.posX + 0.5), (double)(this.posY + 1.0), (double)(this.posZ + 0.5));
        }
    }
    ...
    private void attackWithSomething(EntityLivingBase par1) {
        ...
        if (this.world.getDifficulty() == EnumDifficulty.EASY) {
            ...
            this.playSound(SoundEvent.REGISTRY.getObject(new ResourceLocation("entity.skeleton.shoot")), 0.75f, 1.0f / (this.getRNG().nextFloat() * 0.4f + 0.8f));
            ...
            if (this.world.rand.nextInt(2) == 0) {
                ...
                bf.setNotMe();
                this.playSound(SoundEvent.REGISTRY.getObject(new ResourceLocation("entity.creeper.primed")), 1.0f, 1.0f / (this.getRNG().nextFloat() * 0.4f + 0.8f));
