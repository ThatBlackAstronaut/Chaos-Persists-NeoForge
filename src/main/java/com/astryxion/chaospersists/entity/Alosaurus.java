...
extends EntityMob {
    private static final DataParameter<Byte> ATTACKING = EntityDataManager.createKey(Alosaurus.class, DataSerializers.BYTE);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue((double)ChaosPersists.Alosaurus_stats.attack);
    }
    ...
    protected SoundEvent getAmbientSound() {
        if (this.rand.nextInt(4) == 0) {
            return SoundEvent.REGISTRY.getObject(new ResourceLocation("chaospersists", "alo_living"));
        }
        return null;
    }

    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return SoundEvent.REGISTRY.getObject(new ResourceLocation("chaospersists", "alo_hurt"));
    }

    protected SoundEvent getDeathSound() {
        return SoundEvent.REGISTRY.getObject(new ResourceLocation("chaospersists", "alo_death"));
    }
