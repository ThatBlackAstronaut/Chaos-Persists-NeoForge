...
extends EntityAnt {
    ...
    public boolean interact(EntityPlayer par1EntityPlayer) {
        ...
        if (server != null) {
            if (par1EntityPlayer.dimension != ChaosPersists.getDimension(4)) {
                server.getPlayerList().transferPlayerToDimension((EntityPlayerMP)par1EntityPlayer, ChaosPersists.getDimension(4), (Teleporter)new ChaosTeleporter(server.getWorld(ChaosPersists.getDimension(4)), ChaosPersists.getDimension(4), this.world));
            } else {
