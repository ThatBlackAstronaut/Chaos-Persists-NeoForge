...
extends EntityTameable {
    private static final DataParameter<Integer> I20 = EntityDataManager.createKey(ThePrinceAdult.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> I21 = EntityDataManager.createKey(ThePrinceAdult.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> I22 = EntityDataManager.createKey(ThePrinceAdult.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> I23 = EntityDataManager.createKey(ThePrinceAdult.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> I24 = EntityDataManager.createKey(ThePrinceAdult.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> I25 = EntityDataManager.createKey(ThePrinceAdult.class, DataSerializers.VARINT);
    ...
    public void updateAITasks() {
        ...
        if (this.getActivity() == 0 && this.getPassengers().isEmpty() && this.world.getDifficulty() != EnumDifficulty.PEACEFUL && this.isTamed() && ChaosPersists.FullPowerKingEnable != 0) {
            ++this.growcounter;
            if (this.growcounter > 288000) {
                Entity ent = null;
                TheKing d = null;
                ent = ThePrinceAdult.spawnCreature((World)this.world, (String)"The King", (double)this.posX, (double)this.posY, (double)this.posZ);
                if (ent != null) {
                    d = (TheKing)ent;
                    d.setFree();
                    this.setDead();
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.world.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expand(32.0, 20.0, 32.0));
                ...
                if (!this.getPassengers().isEmpty()) {
                    ...
                    if (!this.world.isRemote && (list = this.world.getEntitiesWithinAABBExcludingEntity((Entity)this, this.getEntityBoundingBox().expand(6.25, 10.0, 6.25))) != null && !list.isEmpty()) {
                        for (int l = 0; l < list.size(); ++l) {
                            ...
                            if (listEntity == (this.getPassengers().isEmpty() ? null : this.getPassengers().get(0)) || listEntity.isDead || !listEntity.canBePushed()) continue;
    ...
    protected void playTameEffect(boolean par1) {
        ...
        for (int i = 0; i < 20; ++i) {
            ...
            this.world.spawnParticle(pt, this.posX + (double)((this.rand.nextFloat() - this.rand.nextFloat()) * 2.5f), this.posY + 0.5 + (double)this.rand.nextFloat() * 1.5, this.posZ + (double)((this.rand.nextFloat() - this.rand.nextFloat()) * 2.5f), d0, d1, d2);
        }
    }
    ...
    public boolean processInteract(EntityPlayer par1EntityPlayer, EnumHand hand) {
        ...
        if (this.isTamed()) {
            ...
            if (var2 != null && var2.getItem() == Items.DIAMOND && par1EntityPlayer.getDistanceSq((Entity)this) < 36.0 && !this.world.isRemote) {
                ...
                ent = ThePrinceAdult.spawnCreature((World)this.world, (String)"The Young Prince", (double)this.posX, (double)this.posY, (double)this.posZ);
                if (ent != null) {
                    d = (ThePrinceTeen)ent;
                    if (this.isTamed()) {
                        d.setTamed(true);
            ...
            if (this.isTamed() && var2 != null && var2.getItem() == Items.NAME_TAG && par1EntityPlayer.getDistanceSq((Entity)this) < 36.0 && this.isOwner(par1EntityPlayer)) {
