...
extends EntityMob {
    private static final DataParameter<Byte> ATTACKING = EntityDataManager.createKey(LurkingTerror.class, DataSerializers.BYTE);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue((double)ChaosPersists.LurkingTerror_stats.attack);
    }
    ...
    protected void updateAITasks() {
        ...
        if (this.rand.nextInt(120) == 0 || this.currentFlightTarget.distanceSq((double)(int)this.posX, (double)(int)this.posY, (double)(int)this.posZ) < 2.1) {
