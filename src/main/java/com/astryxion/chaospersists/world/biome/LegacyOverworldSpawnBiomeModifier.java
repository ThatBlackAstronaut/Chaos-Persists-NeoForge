 ...
 * filtering via {@link LegacyBiomeMatcher}, and {@code getSpawner(category).add(...)} for spawn
 * injection. {@link LegacyOverworldSpawnPopulation} remains a runtime fallback.
 */
