...
/**
 * Injects {@link EntityRegistry#addSpawn} entries when Minecraft actually rolls spawns. The biome
 * modifier path can run before common setup finishes recording legacy spawns; runtime injection
 * matches the mining-dimension {@link BiomeMiningDimension#applyPotentialSpawns} pattern.
 */
