...
/**
 * Minimal teleporter for /utopia command. Places the entity at (targetX, 120, targetZ) in the target dimension.
 */
public class TeleporterUtopia extends Teleporter {
    private final double targetX;
    private final double targetZ;
    private static final double TARGET_Y = 120.0;

    public TeleporterUtopia(WorldServer worldIn, double targetX, double targetZ) {
        super(worldIn);
