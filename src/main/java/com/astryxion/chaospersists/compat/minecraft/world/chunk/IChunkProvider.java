package com.astryxion.chaospersists.compat.minecraft.world.chunk;

import java.util.List;
import com.astryxion.chaospersists.compat.minecraft.util.IProgressUpdate;
...
public interface IChunkProvider {
  ...
  List<Biome.SpawnListEntry> getPossibleCreatures(
      com.astryxion.chaospersists.compat.minecraft.entity.EnumCreatureType creatureType, net.minecraft.core.BlockPos pos);
