...
public class Trees {
    ...
    private void WindTreeBranch(World world, int x, int y, int z, int length, int dirx, int dirz) {
        for (int i = 1; i <= length; ++i) {
            ...
            if (Blocks.AIR == world.getBlockState(new net.minecraft.util.math.BlockPos(x + i * dirx + dirz, y, z + i * dirz + dirx)).getBlock()) {
                ChaosPersists.setBlockFast((World)world, (int)(x + i * dirx + dirz), (int)y, (int)(z + i * dirz + dirx), (Block)Blocks.LEAVES, (int)0, (int)2);
            }
        ...
        if (Blocks.AIR == world.getBlockState(new net.minecraft.util.math.BlockPos(x + (length + 1) * dirx, y, z + (length + 1) * dirz)).getBlock()) {
            ChaosPersists.setBlockFast((World)world, (int)(x + (length + 1) * dirx), (int)y, (int)(z + (length + 1) * dirz), (Block)Blocks.LEAVES, (int)0, (int)2);
        }
        if (Blocks.AIR == world.getBlockState(new net.minecraft.util.math.BlockPos(x + (length + 2) * dirx, y, z + (length + 2) * dirz)).getBlock()) {
            ChaosPersists.setBlockFast((World)world, (int)(x + (length + 2) * dirx), (int)y, (int)(z + (length + 2) * dirz), (Block)Blocks.LEAVES, (int)0, (int)2);
        }
    }
    ...
    public void WindTree(World world, int x, int y, int z, int dir) {
        ...
        for (int j = 0; j < height; ++j) {
            ChaosPersists.setBlockFast((World)world, (int)x, (int)(j + y), (int)z, (Block)Blocks.LOG, (int)0, (int)2);
            if (j <= height / 5) continue;
            ChaosPersists.setBlockFast((World)world, (int)(x + dirx), (int)(j + y), (int)(z + dirz), (Block)Blocks.LEAVES, (int)0, (int)2);
            if (j <= height / 4 || j % 4 != 0) continue;
            this.WindTreeBranch(world, x, j + y, z, height - j, dirx, dirz);
        }
        ChaosPersists.setBlockFast((World)world, (int)x, (int)(y + height), (int)z, (Block)Blocks.LEAVES, (int)0, (int)2);
    }
    ...
    private void SkyTreeBranch(World world, int x, int y, int z, int length, int dirx, int dirz) {
        ...
        if (Blocks.AIR == world.getBlockState(new net.minecraft.util.math.BlockPos(x + length * dirx, y, z + length * dirz)).getBlock()) {
            ChaosPersists.setBlockFast((World)world, (int)(x + length * dirx), (int)y, (int)(z + length * dirz), (Block)Blocks.LEAVES, (int)0, (int)2);
        }
    }
    ...
    public void SkyTree(World world, int x, int y, int z) {
        ...
        ChaosPersists.setBlockFast((World)world, (int)x, (int)(height + 1), (int)z, (Block)Blocks.LEAVES, (int)0, (int)2);
    ...
    public void DuplicatorTree(World world, int x, int y, int z) {
        ...
        for (int tries = 0; tries < 20 && (bidm == Blocks.AIR || bidm == ChaosPersists.MyDT); ++tries) {
            ...
            net.minecraft.block.state.IBlockState metaState = world.getBlockState(new net.minecraft.util.math.BlockPos(x + i, realy + 1, z + j));
            ...
            for (int k = 0; k < 20; ++k) {
                ...
                world.setBlockState(new net.minecraft.util.math.BlockPos(x + i, realy + 1, z + j), metaState, 2);
                return;
            }
        }
    }
    ...
    private void grow_small_branch(World world, int x, int y, int z, int xdir, int zdir, int xxdir, int zzdir) {
        ...
        for (n = 0; n < grow; ++n) {
            ChaosPersists.setBlockFast((World)world, (int)i, (int)j, (int)k, (Block)Blocks.LOG, (int)0, (int)2);
        ...
        grow = 4 + world.rand.nextInt(3);
        for (n = 0; n < grow; ++n) {
            ChaosPersists.setBlockFast((World)world, (int)i2, (int)j, (int)k2, (Block)Blocks.LOG, (int)0, (int)2);
        ...
        grow = 3 + world.rand.nextInt(3);
        for (n = 0; n < grow; ++n) {
            ChaosPersists.setBlockFast((World)world, (int)i2, (int)j2, (int)k2, (Block)Blocks.LOG, (int)0, (int)2);
    ...
    public void ExperienceTree(World world, int x, int y, int z) {
        ...
        for (j = 1; j < 6; ++j) {
            for (i = 0; i < 2; ++i) {
                for (k = 0; k < 2; ++k) {
                    ChaosPersists.setBlockFast((World)world, (int)(x + i), (int)(y + j), (int)(z + k), (Block)Blocks.LOG, (int)0, (int)2);
                }
            }
        }
    ...
    public void makeScragglyBranch(World world, int x, int y, int z, int len, int biasx, int biasz) {
        for (int k = 0; k < len; ++k) {
            ...
            if ((bid = world.getBlockState(new net.minecraft.util.math.BlockPos(x += ix, y += (iy = world.rand.nextInt(3) > 0 ? 1 : 0), z += iz)).getBlock()) != Blocks.AIR && bid != Blocks.LOG && bid != ChaosPersists.MyAppleLeaves) {
                return;
            }
            ChaosPersists.setBlockFast((World)world, (int)x, (int)y, (int)z, (Block)Blocks.LOG, (int)0, (int)2);
            for (int m = -1; m < 2; ++m) {
                for (int n = -1; n < 2; ++n) {
    ...
    public void ScragglyTreeWithBranches(World world, int x, int y, int z) {
        ...
        for (k = 0; k < i; ++k) {
            ...
            ChaosPersists.setBlockFast((World)world, (int)x, (int)(y + k), (int)z, (Block)Blocks.LOG, (int)0, (int)2);
        }
        y += i - 1;
        for (k = i; k < j; ++k) {
    ...
    public void FairyTree(World world, int x, int y, int z) {
        ...
        world.setBlockState(new net.minecraft.util.math.BlockPos(x - 1, y + 1, z), Blocks.MOB_SPAWNER.getDefaultState(), 2);
        ...
        if (tileentitymobspawner != null) {
            tileentitymobspawner.getSpawnerBaseLogic().setEntityId(new net.minecraft.util.ResourceLocation("chaospersists", "fairy"));
        }
        world.setBlockState(new net.minecraft.util.math.BlockPos(x + 2, y + 1, z), Blocks.CHEST.getDefaultState(), 2);
    ...
    public void addSomething(World world, int x, int y, int z) {
        ...
        if (i == 1) {
            world.setBlockState(new net.minecraft.util.math.BlockPos(x, y + 1, z), Blocks.MOB_SPAWNER.getDefaultState(), 2);
        ...
        if (i == 2) {
            world.setBlockState(new net.minecraft.util.math.BlockPos(x, y + 1, z), Blocks.CHEST.getDefaultState(), 2);
