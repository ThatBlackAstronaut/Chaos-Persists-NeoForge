...
public class ModelVelocityRaptor extends EntityModel<VelocityRaptor> {
    ...
    private static MeshDefinition createMesh() {
        ...
        root.addOrReplaceChild("hf3", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0f, 0.0f, 0.0f, 0, 1, 3), PartPose.offsetAndRotation(0.0f, 7.0f, -2.0f, 0.4537856f, 0.0f, 0.0f));
        root.addOrReplaceChild("hf4", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0f, -0.2f, 0.0f, 0, 1, 3), PartPose.offsetAndRotation(0.0f, 8.0f, -1.5f, 0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("hf2", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0f, 0.0f, 0.0f, 0, 1, 3), PartPose.offsetAndRotation(0.0f, 7.0f, -3.5f, 0.6632251f, 0.0f, 0.0f));
        root.addOrReplaceChild("hf1", CubeListBuilder.create().texOffs(0, 1).mirror().addBox(0.0f, 0.0f, 0.0f, 0, 1, 2), PartPose.offsetAndRotation(0.0f, 7.0f, -4.5f, 0.9424778f, 0.0f, 0.0f));
        root.addOrReplaceChild("lff2", CubeListBuilder.create().texOffs(0, 6).mirror().addBox(0.5f, 2.5f, 3.0f, 0, 1, 3), PartPose.offsetAndRotation(2.0f, 14.0f, 1.0f, -0.4537856f, 0.0f, 0.0f));
        root.addOrReplaceChild("lff1", CubeListBuilder.create().texOffs(0, 6).mirror().addBox(0.5f, 2.0f, 2.0f, 0, 1, 3), PartPose.offsetAndRotation(2.0f, 14.0f, 1.0f, -0.2792527f, 0.0f, 0.0f));
        root.addOrReplaceChild("lff3", CubeListBuilder.create().texOffs(0, 6).mirror().addBox(0.5f, 1.0f, 4.0f, 0, 1, 3), PartPose.offsetAndRotation(2.0f, 14.0f, 1.0f, -1.047198f, 0.0f, 0.0f));
        root.addOrReplaceChild("rff2", CubeListBuilder.create().texOffs(0, 6).mirror().addBox(-0.5f, 2.5f, 3.0f, 0, 1, 3), PartPose.offsetAndRotation(-2.0f, 14.0f, 1.0f, -0.4537856f, 0.0f, 0.0f));
        root.addOrReplaceChild("rff3", CubeListBuilder.create().texOffs(0, 6).mirror().addBox(-0.5f, 1.0f, 4.0f, 0, 1, 3), PartPose.offsetAndRotation(-2.0f, 14.0f, 1.0f, -1.047198f, 0.0f, 0.0f));
        root.addOrReplaceChild("rff1", CubeListBuilder.create().texOffs(0, 6).mirror().addBox(-0.5f, 2.0f, 2.0f, 0, 1, 3), PartPose.offsetAndRotation(-2.0f, 14.0f, 1.0f, -0.2792527f, 0.0f, 0.0f));
        root.addOrReplaceChild("tf4", CubeListBuilder.create().texOffs(0, 3).mirror().addBox(0.0f, 0.0f, 0.0f, 0, 1, 3), PartPose.offsetAndRotation(0.0f, 11.0f, 25.0f, -0.5410521f, 0.0f, 0.0f));
        root.addOrReplaceChild("tf1", CubeListBuilder.create().texOffs(0, 3).mirror().addBox(0.0f, 0.0f, 0.0f, 0, 1, 3), PartPose.offsetAndRotation(0.0f, 11.0f, 19.0f, -0.5410521f, 0.0f, 0.0f));
        root.addOrReplaceChild("shape1", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-2.0f, 0.0f, 0.0f, 4, 7, 11), PartPose.offset(0.0f, 10.0f, 0.0f));
        root.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(0, 19).mirror().addBox(-1.0f, -7.0f, -2.0f, 2, 8, 3), PartPose.offsetAndRotation(0.0f, 12.0f, 2.0f, 1.082104f, 0.0f, 0.0f));
        root.addOrReplaceChild("head1", CubeListBuilder.create().texOffs(0, 49).mirror().addBox(-2.0f, 0.0f, -7.0f, 3, 4, 7), PartPose.offset(0.5f, 7.0f, -1.0f));
        root.addOrReplaceChild("lf1", CubeListBuilder.create().texOffs(0, 31).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 3, 2), PartPose.offsetAndRotation(2.0f, 14.0f, 1.0f, 0.2792527f, 0.0f, 0.0f));
        root.addOrReplaceChild("lf2", CubeListBuilder.create().texOffs(16, 19).mirror().addBox(0.0f, 1.0f, 2.0f, 1, 4, 1), PartPose.offsetAndRotation(2.0f, 14.0f, 1.0f, -0.4363323f, 0.0f, 0.0f));
        root.addOrReplaceChild("head2", CubeListBuilder.create().texOffs(20, 0).mirror().addBox(-1.0f, 0.0f, -10.0f, 2, 4, 4), PartPose.offset(0.0f, 7.0f, -1.0f));
        root.addOrReplaceChild("tail1", CubeListBuilder.create().texOffs(0, 38).mirror().addBox(-1.0f, 0.0f, 0.0f, 2, 5, 4), PartPose.offset(0.0f, 10.0f, 11.0f));
        root.addOrReplaceChild("tail2", CubeListBuilder.create().texOffs(26, 11).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 2, 10), PartPose.offset(-0.5f, 10.0f, 15.0f));
        root.addOrReplaceChild("bl1", CubeListBuilder.create().texOffs(22, 24).mirror().addBox(-1.0f, 0.0f, 0.0f, 2, 6, 4), PartPose.offset(2.0f, 13.0f, 6.0f));
        root.addOrReplaceChild("br1", CubeListBuilder.create().texOffs(36, 0).mirror().addBox(-1.0f, 0.0f, 0.0f, 2, 6, 4), PartPose.offset(-2.0f, 13.0f, 6.0f));
        root.addOrReplaceChild("bl2", CubeListBuilder.create().texOffs(12, 26).mirror().addBox(-1.0f, 5.0f, -3.0f, 2, 5, 2), PartPose.offsetAndRotation(2.0f, 13.0f, 6.0f, 0.4886922f, 0.0f, 0.0f));
        root.addOrReplaceChild("br2", CubeListBuilder.create().texOffs(13, 36).mirror().addBox(-1.0f, 5.0f, -3.0f, 2, 5, 2), PartPose.offsetAndRotation(-2.0f, 13.0f, 6.0f, 0.4886922f, 0.0f, 0.0f));
        root.addOrReplaceChild("bl3", CubeListBuilder.create().texOffs(28, 39).mirror().addBox(-1.0f, 9.0f, -1.0f, 2, 2, 4), PartPose.offset(2.0f, 13.0f, 6.0f));
        root.addOrReplaceChild("br3", CubeListBuilder.create().texOffs(18, 45).mirror().addBox(-1.0f, 9.0f, -1.0f, 2, 2, 4), PartPose.offset(-2.0f, 13.0f, 6.0f));
        root.addOrReplaceChild("rf1", CubeListBuilder.create().texOffs(35, 31).mirror().addBox(-1.0f, 0.0f, 0.0f, 1, 3, 2), PartPose.offsetAndRotation(-2.0f, 14.0f, 1.0f, 0.2792527f, 0.0f, 0.0f));
        root.addOrReplaceChild("rf2", CubeListBuilder.create().texOffs(11, 19).mirror().addBox(-1.0f, 1.0f, 2.0f, 1, 4, 1), PartPose.offsetAndRotation(-2.0f, 14.0f, 1.0f, -0.4363323f, 0.0f, 0.0f));
        root.addOrReplaceChild("tf2", CubeListBuilder.create().texOffs(0, 3).mirror().addBox(0.0f, 0.0f, 0.0f, 0, 1, 3), PartPose.offsetAndRotation(0.0f, 11.0f, 21.0f, -0.5410521f, 0.0f, 0.0f));
        root.addOrReplaceChild("tf3", CubeListBuilder.create().texOffs(0, 3).mirror().addBox(0.0f, 0.0f, 0.0f, 0, 1, 3), PartPose.offsetAndRotation(0.0f, 11.0f, 23.0f, -0.5410521f, 0.0f, 0.0f));
        root.addOrReplaceChild("bl4", CubeListBuilder.create().texOffs(31, 10).mirror().addBox(-1.0f, 6.0f, -5.0f, 1, 3, 1), PartPose.offsetAndRotation(2.0f, 13.0f, 6.0f, 0.6283185f, 0.0f, 0.0f));
        root.addOrReplaceChild("br4", CubeListBuilder.create().texOffs(31, 15).mirror().addBox(0.0f, 6.0f, -5.0f, 1, 3, 1), PartPose.offsetAndRotation(-2.0f, 13.0f, 6.0f, 0.6283185f, 0.0f, 0.0f));
        root.addOrReplaceChild("hat1", CubeListBuilder.create().texOffs(50, 0).mirror().addBox(0.0f, 0.0f, 0.0f, 4, 1, 5), PartPose.offset(-2.0f, 6.0f, -6.0f));
        root.addOrReplaceChild("hat2", CubeListBuilder.create().texOffs(50, 0).mirror().addBox(0.0f, 0.0f, 0.0f, 3, 2, 3), PartPose.offset(-1.5f, 4.0f, -4.0f));
        return mesh;
    }
