...
public class ModelMolenoid extends EntityModel<Molenoid> {
    ...
    public static MeshDefinition createMesh() {
        ...
        partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 176).mirror().addBox(-16.0f, 0.0f, 0.0f, 32, 20, 56), PartPose.offsetAndRotation(0.0f, 1.0f, 6.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("shoulders", CubeListBuilder.create().texOffs(0, 143).mirror().addBox(-17.0f, 0.0f, 0.0f, 34, 17, 10), PartPose.offsetAndRotation(0.0f, 3.0f, -4.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("head1", CubeListBuilder.create().texOffs(0, 114).mirror().addBox(-14.0f, 0.0f, 0.0f, 28, 14, 10), PartPose.offsetAndRotation(0.0f, 5.0f, -14.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("head2", CubeListBuilder.create().texOffs(0, 89).mirror().addBox(-11.0f, 0.0f, 0.0f, 22, 10, 10), PartPose.offsetAndRotation(0.0f, 6.0f, -24.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("head3", CubeListBuilder.create().texOffs(0, 67).mirror().addBox(-4.0f, 0.0f, 0.0f, 8, 8, 10), PartPose.offsetAndRotation(0.0f, 7.0f, -34.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("nosestar1", CubeListBuilder.create().texOffs(0, 32).mirror().addBox(-0.5f, -8.0f, 0.0f, 1, 16, 1), PartPose.offsetAndRotation(0.0f, 11.0f, -35.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("nosestar2", CubeListBuilder.create().texOffs(20, 32).mirror().addBox(-0.5f, -8.0f, 0.0f, 1, 16, 1), PartPose.offsetAndRotation(0.0f, 11.0f, -35.0f, 0.0f, 0.0f, 1.047198f));
        partdefinition.addOrReplaceChild("nosestar3", CubeListBuilder.create().texOffs(40, 32).mirror().addBox(-0.5f, -8.0f, 0.0f, 1, 16, 1), PartPose.offsetAndRotation(0.0f, 11.0f, -35.0f, 0.0f, 0.0f, -1.047198f));
        partdefinition.addOrReplaceChild("larm", CubeListBuilder.create().texOffs(80, 0).mirror().addBox(0.0f, 0.0f, -2.0f, 17, 11, 5), PartPose.offsetAndRotation(13.0f, 8.0f, 0.0f, 0.0f, 0.6283185f, 0.0f));
        partdefinition.addOrReplaceChild("lhand", CubeListBuilder.create().texOffs(80, 20).mirror().addBox(0.0f, 0.0f, -2.0f, 12, 14, 4), PartPose.offsetAndRotation(25.0f, 7.0f, -9.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("lclaw1", CubeListBuilder.create().texOffs(80, 42).mirror().addBox(0.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(35.0f, 20.0f, -9.0f, 0.0f, -0.1745329f, 0.0f));
        partdefinition.addOrReplaceChild("lclaw2", CubeListBuilder.create().texOffs(80, 52).mirror().addBox(0.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(35.0f, 15.0f, -9.0f, 0.0f, -0.1745329f, 0.0f));
        partdefinition.addOrReplaceChild("lclaw3", CubeListBuilder.create().texOffs(80, 62).mirror().addBox(0.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(35.0f, 10.0f, -9.0f, 0.0f, -0.1745329f, 0.0f));
        partdefinition.addOrReplaceChild("lclaw4", CubeListBuilder.create().texOffs(80, 72).mirror().addBox(0.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(35.0f, 5.0f, -9.0f, 0.0f, -0.1745329f, 0.0f));
        partdefinition.addOrReplaceChild("nosestar4", CubeListBuilder.create().texOffs(10, 32).mirror().addBox(-0.5f, -8.0f, 0.0f, 1, 16, 1), PartPose.offsetAndRotation(0.0f, 11.0f, -35.0f, 0.0f, 0.0f, 0.5235988f));
        partdefinition.addOrReplaceChild("nosestar5", CubeListBuilder.create().texOffs(30, 32).mirror().addBox(-0.5f, -8.0f, 0.0f, 1, 16, 1), PartPose.offsetAndRotation(0.0f, 11.0f, -35.0f, 0.0f, 0.0f, 1.570796f));
        partdefinition.addOrReplaceChild("nosestar6", CubeListBuilder.create().texOffs(50, 32).mirror().addBox(-0.5f, -8.0f, 0.0f, 1, 16, 1), PartPose.offsetAndRotation(0.0f, 11.0f, -35.0f, 0.0f, 0.0f, -0.5235988f));
        partdefinition.addOrReplaceChild("butt", CubeListBuilder.create().texOffs(196, 215).mirror().addBox(-11.0f, 0.0f, 0.0f, 22, 11, 5), PartPose.offsetAndRotation(0.0f, 6.0f, 62.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(196, 200).mirror().addBox(-2.0f, 0.0f, 0.0f, 4, 3, 5), PartPose.offsetAndRotation(0.0f, 7.0f, 67.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("lleg", CubeListBuilder.create().texOffs(90, 80).mirror().addBox(0.0f, 0.0f, -2.0f, 17, 11, 5), PartPose.offsetAndRotation(14.0f, 9.0f, 58.0f, 0.0f, 0.6283185f, 0.0f));
        partdefinition.addOrReplaceChild("lfoot", CubeListBuilder.create().texOffs(90, 100).mirror().addBox(0.0f, 0.0f, -2.0f, 12, 14, 4), PartPose.offsetAndRotation(26.0f, 8.0f, 49.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("ltoe1", CubeListBuilder.create().texOffs(90, 120).mirror().addBox(0.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(36.0f, 21.0f, 48.0f, 0.0f, -0.2617994f, 0.0f));
        partdefinition.addOrReplaceChild("ltoe2", CubeListBuilder.create().texOffs(90, 130).mirror().addBox(0.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(36.0f, 16.0f, 48.0f, 0.0f, -0.2617994f, 0.0f));
        partdefinition.addOrReplaceChild("ltoe3", CubeListBuilder.create().texOffs(90, 140).mirror().addBox(0.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(36.0f, 11.0f, 48.0f, 0.0f, -0.2617994f, 0.0f));
        partdefinition.addOrReplaceChild("ltoe4", CubeListBuilder.create().texOffs(90, 150).mirror().addBox(0.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(36.0f, 6.0f, 48.0f, 0.0f, -0.2617994f, 0.0f));
        partdefinition.addOrReplaceChild("rarm", CubeListBuilder.create().texOffs(130, 0).mirror().addBox(-17.0f, 0.0f, -2.0f, 17, 11, 5), PartPose.offsetAndRotation(-14.0f, 8.0f, 0.0f, 0.0f, -0.6283185f, 0.0f));
        partdefinition.addOrReplaceChild("rhand", CubeListBuilder.create().texOffs(130, 20).mirror().addBox(-12.0f, 0.0f, -2.0f, 12, 14, 4), PartPose.offsetAndRotation(-26.0f, 7.0f, -9.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("rclaw1", CubeListBuilder.create().texOffs(130, 42).mirror().addBox(-13.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(-36.0f, 20.0f, -9.0f, 0.0f, 0.1745329f, 0.0f));
        partdefinition.addOrReplaceChild("rclaw2", CubeListBuilder.create().texOffs(130, 52).mirror().addBox(-13.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(-36.0f, 15.0f, -9.0f, 0.0f, 0.1745329f, 0.0f));
        partdefinition.addOrReplaceChild("rclaw3", CubeListBuilder.create().texOffs(130, 62).mirror().addBox(-13.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(-36.0f, 10.0f, -9.0f, 0.0f, 0.1745329f, 0.0f));
        partdefinition.addOrReplaceChild("rclaw4", CubeListBuilder.create().texOffs(130, 72).mirror().addBox(-13.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(-36.0f, 5.0f, -9.0f, 0.0f, 0.1745329f, 0.0f));
        partdefinition.addOrReplaceChild("rleg", CubeListBuilder.create().texOffs(150, 80).mirror().addBox(-17.0f, 0.0f, -2.0f, 17, 11, 5), PartPose.offsetAndRotation(-14.0f, 9.0f, 58.0f, 0.0f, -0.6283185f, 0.0f));
        partdefinition.addOrReplaceChild("rfoot", CubeListBuilder.create().texOffs(150, 100).mirror().addBox(-12.0f, 0.0f, -2.0f, 12, 14, 4), PartPose.offsetAndRotation(-26.0f, 8.0f, 49.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("rtoe1", CubeListBuilder.create().texOffs(150, 120).mirror().addBox(-13.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(-36.0f, 21.0f, 48.0f, 0.0f, 0.2617994f, 0.0f));
        partdefinition.addOrReplaceChild("rtoe2", CubeListBuilder.create().texOffs(150, 130).mirror().addBox(-13.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(-36.0f, 16.0f, 48.0f, 0.0f, 0.2617994f, 0.0f));
        partdefinition.addOrReplaceChild("rtoe3", CubeListBuilder.create().texOffs(150, 140).mirror().addBox(-13.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(-36.0f, 11.0f, 48.0f, 0.0f, 0.2617994f, 0.0f));
        partdefinition.addOrReplaceChild("rtoe4", CubeListBuilder.create().texOffs(150, 150).mirror().addBox(-13.0f, 0.0f, -1.0f, 13, 3, 2), PartPose.offsetAndRotation(-36.0f, 6.0f, 48.0f, 0.0f, 0.2617994f, 0.0f));
