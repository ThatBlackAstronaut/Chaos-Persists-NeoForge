...
public class ModelBee extends EntityModel<Bee> {
    ...
    private static MeshDefinition createMesh() {
        ...
        root.addOrReplaceChild("Sting", CubeListBuilder.create().texOffs(68, 0).mirror().addBox(-1.0f, 0.0f, -1.0f, 2, 10, 2), PartPose.offsetAndRotation(0.0f, 16.0f, 1.0f, -0.7853982f, 0.0f, 0.0f));
        root.addOrReplaceChild("Abdomnem1", CubeListBuilder.create().texOffs(64, 12).mirror().addBox(-2.0f, 0.0f, 0.0f, 4, 8, 4), PartPose.offsetAndRotation(0.0f, 9.0f, 2.0f, -0.5235988f, 0.0f, 0.0f));
        root.addOrReplaceChild("Abdomnem2", CubeListBuilder.create().texOffs(60, 24).mirror().addBox(-3.0f, 0.0f, 0.0f, 6, 6, 6), PartPose.offset(0.0f, 5.0f, 0.0f));
        root.addOrReplaceChild("Abdomnem3", CubeListBuilder.create().texOffs(56, 36).mirror().addBox(-4.0f, 0.0f, 0.0f, 8, 7, 8), PartPose.offsetAndRotation(0.0f, 1.0f, -2.0f, 0.2617994f, 0.0f, 0.0f));
        root.addOrReplaceChild("Abdomnem4", CubeListBuilder.create().texOffs(53, 51).mirror().addBox(-5.0f, 0.0f, 0.0f, 10, 12, 10), PartPose.offsetAndRotation(0.0f, -6.0f, -8.0f, 0.5934119f, 0.0f, 0.0f));
        root.addOrReplaceChild("Abdomnem5", CubeListBuilder.create().texOffs(48, 73).mirror().addBox(-6.0f, 0.0f, 0.0f, 12, 12, 12), PartPose.offsetAndRotation(0.0f, -6.0f, -15.0f, 1.099557f, 0.0f, 0.0f));
        root.addOrReplaceChild("MainBody", CubeListBuilder.create().texOffs(48, 97).mirror().addBox(-6.0f, 0.0f, -6.0f, 12, 14, 12), PartPose.offsetAndRotation(0.0f, -12.0f, -24.0f, 1.48353f, 0.0f, 0.0f));
        root.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(55, 123).mirror().addBox(-4.0f, -4.0f, -8.0f, 8, 8, 8), PartPose.offset(0.0f, -12.0f, -23.0f));
        root.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(51, 139).mirror().addBox(-5.0f, -5.0f, -10.0f, 10, 10, 10), PartPose.offsetAndRotation(0.0f, -13.0f, -28.0f, 0.2617994f, 0.0f, 0.0f));
        root.addOrReplaceChild("WingRight", CubeListBuilder.create().texOffs(0, 91).mirror().addBox(0.0f, 0.0f, 0.0f, 0, 8, 24), PartPose.offsetAndRotation(-4.0f, -14.0f, -15.0f, -0.7853982f, -0.5235988f, 2.617994f));
        root.addOrReplaceChild("WingLeft", CubeListBuilder.create().texOffs(96, 91).mirror().addBox(0.0f, 0.0f, 0.0f, 0, 8, 24), PartPose.offsetAndRotation(3.0f, -14.0f, -15.0f, -0.7853982f, 0.5235988f, -2.617994f));
        root.addOrReplaceChild("RA1", CubeListBuilder.create().texOffs(47, 152).mirror().addBox(0.0f, -6.0f, -1.0f, 1, 6, 1), PartPose.offsetAndRotation(-3.0f, -17.0f, -31.0f, 0.2617994f, 0.5235988f, 0.0f));
        root.addOrReplaceChild("LA1", CubeListBuilder.create().texOffs(91, 152).mirror().addBox(0.0f, -6.0f, -1.0f, 1, 6, 1), PartPose.offsetAndRotation(2.0f, -17.0f, -32.0f, 0.2617994f, -0.5235988f, 0.0f));
        root.addOrReplaceChild("LA2", CubeListBuilder.create().texOffs(91, 145).mirror().addBox(0.0f, -11.0f, 0.0f, 1, 6, 1), PartPose.offsetAndRotation(2.0f, -17.0f, -32.0f, 0.4363323f, -0.6108652f, 0.0f));
        root.addOrReplaceChild("RA2", CubeListBuilder.create().texOffs(47, 145).mirror().addBox(0.0f, -11.0f, 0.0f, 1, 6, 1), PartPose.offsetAndRotation(-3.0f, -17.0f, -31.0f, 0.4363323f, 0.6108652f, 0.0f));
        root.addOrReplaceChild("RA3", CubeListBuilder.create().texOffs(47, 138).mirror().addBox(0.0f, -16.0f, 2.0f, 1, 6, 1), PartPose.offsetAndRotation(-3.0f, -17.0f, -31.0f, 0.6108652f, 0.6981317f, 0.0f));
        root.addOrReplaceChild("LA3", CubeListBuilder.create().texOffs(91, 138).mirror().addBox(0.0f, -16.0f, 2.0f, 1, 6, 1), PartPose.offsetAndRotation(2.0f, -17.0f, -32.0f, 0.6108652f, -0.6981317f, 0.0f));
        root.addOrReplaceChild("LeftPom", CubeListBuilder.create().texOffs(89, 134).mirror().addBox(4.0f, -16.0f, -6.0f, 2, 2, 2), PartPose.offset(2.0f, -17.0f, -32.0f));
        root.addOrReplaceChild("RightPom", CubeListBuilder.create().texOffs(45, 134).mirror().addBox(-5.0f, -16.0f, -7.0f, 2, 2, 2), PartPose.offset(-3.0f, -17.0f, -31.0f));
        root.addOrReplaceChild("LeftPincerExtra", CubeListBuilder.create().texOffs(71, 166).mirror().addBox(-2.0f, 0.0f, -6.0f, 2, 1, 2), PartPose.offsetAndRotation(2.0f, -8.0f, -36.0f, 0.1745329f, -0.1745329f, 0.0f));
        root.addOrReplaceChild("LeftPincerMain", CubeListBuilder.create().texOffs(71, 159).mirror().addBox(0.0f, 0.0f, -6.0f, 2, 1, 6), PartPose.offsetAndRotation(2.0f, -8.0f, -36.0f, 0.1745329f, -0.1745329f, 0.0f));
        root.addOrReplaceChild("RightPincerMain", CubeListBuilder.create().texOffs(55, 159).mirror().addBox(0.0f, 0.0f, -6.0f, 2, 1, 6), PartPose.offsetAndRotation(-4.0f, -8.0f, -36.0f, 0.1745329f, 0.1745329f, 0.0f));
        root.addOrReplaceChild("RightPincerExtra", CubeListBuilder.create().texOffs(63, 166).mirror().addBox(2.0f, 0.0f, -6.0f, 2, 1, 2), PartPose.offsetAndRotation(-4.0f, -8.0f, -36.0f, 0.1745329f, 0.1745329f, 0.0f));
        return mesh;
    }
