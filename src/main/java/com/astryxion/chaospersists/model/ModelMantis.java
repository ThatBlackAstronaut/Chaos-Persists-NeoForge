...
public class ModelMantis extends EntityModel<Mantis> {
    ...
    private static MeshDefinition createMesh() {
        ...
        root.addOrReplaceChild("lfleg1", CubeListBuilder.create().texOffs(28, 35).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 10, 1), PartPose.offsetAndRotation(27.0f, 16.0f, -3.0f, 0.0f, 0.0f, -0.6283185f));
        root.addOrReplaceChild("lfleg2", CubeListBuilder.create().texOffs(0, 32).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 22, 1), PartPose.offsetAndRotation(21.0f, -5.0f, -3.0f, 0.0f, 0.0f, -0.2792527f));
        root.addOrReplaceChild("lfleg3", CubeListBuilder.create().texOffs(64, 2).mirror().addBox(0.0f, 0.0f, 0.0f, 20, 1, 1), PartPose.offsetAndRotation(2.0f, -5.0f, 0.0f, 0.0f, 0.1570796f, 0.0f));
        root.addOrReplaceChild("lfleg4", CubeListBuilder.create().texOffs(64, 20).mirror().addBox(15.0f, 0.0f, -2.0f, 4, 1, 5), PartPose.offsetAndRotation(2.0f, -5.0f, 0.0f, 0.0f, 0.1570796f, 0.0f));
        root.addOrReplaceChild("lrleg1", CubeListBuilder.create().texOffs(35, 35).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 10, 1), PartPose.offsetAndRotation(32.0f, 18.0f, 11.0f, 0.0f, 0.0f, -0.8726646f));
        root.addOrReplaceChild("lrleg2", CubeListBuilder.create().texOffs(14, 32).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 22, 1), PartPose.offsetAndRotation(21.0f, 0.0f, 11.0f, 0.0f, 0.0f, -0.5410521f));
        root.addOrReplaceChild("lrleg3", CubeListBuilder.create().texOffs(64, 11).mirror().addBox(0.0f, 0.0f, 0.0f, 20, 1, 1), PartPose.offsetAndRotation(2.0f, 0.0f, 8.0f, 0.0f, -0.1570796f, 0.0f));
        root.addOrReplaceChild("lrleg4", CubeListBuilder.create().texOffs(64, 36).mirror().addBox(15.0f, 0.0f, -2.0f, 4, 1, 5), PartPose.offsetAndRotation(2.0f, 0.0f, 8.0f, 0.0f, -0.1570796f, 0.0f));
        root.addOrReplaceChild("abdomen", CubeListBuilder.create().texOffs(118, 0).mirror().addBox(0.0f, 0.0f, 0.0f, 9, 5, 53), PartPose.offsetAndRotation(-4.0f, -11.0f, 0.0f, -0.5061455f, 0.0f, 0.0f));
        root.addOrReplaceChild("thorax", CubeListBuilder.create().texOffs(145, 62).mirror().addBox(0.0f, 0.0f, 0.0f, 15, 3, 13), PartPose.offsetAndRotation(-7.0f, -14.0f, -12.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("neck1", CubeListBuilder.create().texOffs(145, 82).mirror().addBox(0.0f, 0.0f, 0.0f, 9, 1, 15), PartPose.offsetAndRotation(-4.0f, -15.0f, -27.0f, -0.0698132f, 0.0f, 0.0f));
        root.addOrReplaceChild("neck2", CubeListBuilder.create().texOffs(40, 150).mirror().addBox(0.0f, 0.0f, 0.0f, 3, 1, 2), PartPose.offset(-1.0f, -15.0f, -29.0f));
        root.addOrReplaceChild("head1", CubeListBuilder.create().texOffs(0, 150).mirror().addBox(0.0f, 0.0f, 0.0f, 2, 6, 1), PartPose.offsetAndRotation(0.0f, -16.0f, -30.0f, 0.0f, 0.0f, 0.1396263f));
        root.addOrReplaceChild("head2", CubeListBuilder.create().texOffs(10, 150).mirror().addBox(-2.0f, 0.0f, 0.0f, 2, 6, 1), PartPose.offsetAndRotation(0.0f, -16.0f, -30.0f, 0.0f, 0.0f, -0.1745329f));
        root.addOrReplaceChild("leye", CubeListBuilder.create().texOffs(20, 150).mirror().addBox(1.0f, 0.0f, -0.5f, 2, 2, 1), PartPose.offsetAndRotation(0.0f, -16.0f, -30.0f, 0.0f, 0.0f, 0.1396263f));
        root.addOrReplaceChild("reye", CubeListBuilder.create().texOffs(30, 150).mirror().addBox(-3.0f, 0.0f, -0.5f, 2, 2, 1), PartPose.offsetAndRotation(0.0f, -16.0f, -30.0f, 0.0f, 0.0f, -0.1745329f));
        root.addOrReplaceChild("lantenna", CubeListBuilder.create().texOffs(53, 150).mirror().addBox(0.0f, -20.0f, 0.0f, 1, 20, 1), PartPose.offsetAndRotation(0.0f, -16.0f, -30.0f, 0.0f, 0.0f, 0.2792527f));
        root.addOrReplaceChild("rantenna", CubeListBuilder.create().texOffs(60, 150).mirror().addBox(-1.0f, -20.0f, 0.0f, 1, 20, 1), PartPose.offsetAndRotation(0.0f, -16.0f, -30.0f, 0.0f, 0.0f, -0.2792527f));
        root.addOrReplaceChild("larm1", CubeListBuilder.create().texOffs(51, 0).mirror().addBox(0.0f, 0.0f, -1.0f, 1, 23, 4), PartPose.offsetAndRotation(2.0f, -14.0f, -23.0f, 0.0349066f, 0.0f, 0.0f));
        root.addOrReplaceChild("larm2", CubeListBuilder.create().texOffs(30, 0).mirror().addBox(0.0f, -18.0f, -2.0f, 1, 18, 2), PartPose.offsetAndRotation(2.0f, 8.0f, -22.0f, 0.5585054f, 0.0f, 0.0f));
        root.addOrReplaceChild("larm3", CubeListBuilder.create().texOffs(16, 0).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 21, 1), PartPose.offset(2.0f, -7.0f, -33.0f));
        root.addOrReplaceChild("lfwing", CubeListBuilder.create().texOffs(0, 67).mirror().addBox(0.0f, 0.0f, 0.0f, 48, 1, 12), PartPose.offsetAndRotation(2.0f, -11.0f, 0.0f, -0.2268928f, 0.0f, -0.6981317f));
        root.addOrReplaceChild("rfwing", CubeListBuilder.create().texOffs(0, 83).mirror().addBox(-48.0f, 0.0f, 0.0f, 48, 1, 12), PartPose.offsetAndRotation(-1.0f, -11.0f, 0.0f, -0.2268928f, 0.0f, 0.6981317f));
        root.addOrReplaceChild("lrwing", CubeListBuilder.create().texOffs(0, 100).mirror().addBox(0.0f, 0.0f, 0.0f, 42, 1, 17), PartPose.offsetAndRotation(2.0f, -6.0f, 10.0f, -0.2268928f, 0.0f, -0.3490659f));
        root.addOrReplaceChild("rrwing", CubeListBuilder.create().texOffs(0, 122).mirror().addBox(-42.0f, 0.0f, 0.0f, 42, 1, 17), PartPose.offsetAndRotation(-1.0f, -6.0f, 10.0f, -0.2268928f, 0.0f, 0.3490659f));
        root.addOrReplaceChild("rarm1", CubeListBuilder.create().texOffs(38, 0).mirror().addBox(0.0f, 0.0f, -1.0f, 1, 23, 4), PartPose.offsetAndRotation(-1.0f, -14.0f, -23.0f, 0.0349066f, 0.0f, 0.0f));
        root.addOrReplaceChild("rarm2", CubeListBuilder.create().texOffs(22, 0).mirror().addBox(0.0f, -18.0f, -2.0f, 1, 18, 2), PartPose.offsetAndRotation(-1.0f, 8.0f, -22.0f, 0.5585054f, 0.0f, 0.0f));
        root.addOrReplaceChild("rarm3", CubeListBuilder.create().texOffs(10, 0).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 21, 1), PartPose.offset(-1.0f, -7.0f, -33.0f));
        root.addOrReplaceChild("rlfleg3", CubeListBuilder.create().texOffs(64, 6).mirror().addBox(-20.0f, 0.0f, 0.0f, 20, 1, 1), PartPose.offsetAndRotation(-1.0f, -5.0f, 0.0f, 0.0f, -0.1570796f, 0.0f));
        root.addOrReplaceChild("rfleg4", CubeListBuilder.create().texOffs(64, 28).mirror().addBox(-19.0f, 0.0f, -2.0f, 4, 1, 5), PartPose.offsetAndRotation(-1.0f, -5.0f, 0.0f, 0.0f, -0.1570796f, 0.0f));
        root.addOrReplaceChild("rfleg2", CubeListBuilder.create().texOffs(7, 32).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 22, 1), PartPose.offsetAndRotation(-21.0f, -5.0f, -3.0f, 0.0f, 0.0f, 0.2792527f));
        root.addOrReplaceChild("rfleg1", CubeListBuilder.create().texOffs(42, 35).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 10, 1), PartPose.offsetAndRotation(-27.0f, 16.0f, -3.0f, 0.0f, 0.0f, 0.6283185f));
        root.addOrReplaceChild("rrleg3", CubeListBuilder.create().texOffs(64, 16).mirror().addBox(-20.0f, 0.0f, 0.0f, 20, 1, 1), PartPose.offsetAndRotation(-1.0f, 0.0f, 8.0f, 0.0f, 0.1570796f, 0.0f));
        root.addOrReplaceChild("rrleg4", CubeListBuilder.create().texOffs(64, 44).mirror().addBox(-19.0f, 0.0f, -2.0f, 4, 1, 5), PartPose.offsetAndRotation(-1.0f, 0.0f, 8.0f, 0.0f, 0.1570796f, 0.0f));
        root.addOrReplaceChild("rrleg2", CubeListBuilder.create().texOffs(21, 32).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 22, 1), PartPose.offsetAndRotation(-21.0f, 0.0f, 11.0f, 0.0f, 0.0f, 0.5410521f));
        root.addOrReplaceChild("rrleg1", CubeListBuilder.create().texOffs(49, 35).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 10, 1), PartPose.offsetAndRotation(-32.0f, 18.0f, 11.0f, 0.0f, 0.0f, 0.8726646f));
        return mesh;
    }
