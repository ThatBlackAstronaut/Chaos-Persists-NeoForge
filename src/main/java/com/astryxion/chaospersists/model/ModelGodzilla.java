...
public class ModelGodzilla extends EntityModel<Godzilla> {
    ...
    public static MeshDefinition createMesh() {
        ...
        partdefinition.addOrReplaceChild("LToe1", CubeListBuilder.create().texOffs(45, 1002).mirror().addBox(-5.0f, -2.0f, -40.0f, 10, 10, 6), PartPose.offsetAndRotation(54.0f, 16.0f, 6.0f, 0.0f, 0.7853982f, 0.0f));
        partdefinition.addOrReplaceChild("LToe3", CubeListBuilder.create().texOffs(0, 955).mirror().addBox(-8.0f, -8.0f, -26.0f, 16, 16, 30), PartPose.offsetAndRotation(54.0f, 16.0f, 6.0f, 0.0f, 0.7853982f, 0.0f));
        partdefinition.addOrReplaceChild("LToe2", CubeListBuilder.create().texOffs(0, 1002).mirror().addBox(-7.0f, -6.0f, -34.0f, 14, 14, 8), PartPose.offsetAndRotation(54.0f, 16.0f, 6.0f, 0.0f, 0.7853982f, 0.0f));
        partdefinition.addOrReplaceChild("LToe9", CubeListBuilder.create().texOffs(0, 955).mirror().addBox(-8.0f, -8.0f, -26.0f, 16, 16, 30), PartPose.offsetAndRotation(54.0f, 16.0f, 6.0f, 0.0f, -0.7853982f, 0.0f));
        partdefinition.addOrReplaceChild("LToe8", CubeListBuilder.create().texOffs(0, 1002).mirror().addBox(-7.0f, -6.0f, -34.0f, 14, 14, 8), PartPose.offsetAndRotation(54.0f, 16.0f, 6.0f, 0.0f, -0.7853982f, 0.0f));
        partdefinition.addOrReplaceChild("LToe7", CubeListBuilder.create().texOffs(45, 1002).mirror().addBox(-5.0f, -2.0f, -40.0f, 10, 10, 6), PartPose.offsetAndRotation(54.0f, 16.0f, 6.0f, 0.0f, -0.7853982f, 0.0f));
        partdefinition.addOrReplaceChild("LToe6", CubeListBuilder.create().texOffs(92, 955).mirror().addBox(-8.0f, -8.0f, -26.0f, 16, 16, 36), PartPose.offsetAndRotation(54.0f, 16.0f, 6.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("LToe5", CubeListBuilder.create().texOffs(0, 1002).mirror().addBox(-7.0f, -6.0f, -34.0f, 14, 14, 8), PartPose.offsetAndRotation(54.0f, 16.0f, 6.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("LToe4", CubeListBuilder.create().texOffs(45, 1002).mirror().addBox(-5.0f, -2.0f, -40.0f, 10, 10, 6), PartPose.offsetAndRotation(54.0f, 16.0f, 6.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("RToe9", CubeListBuilder.create().texOffs(0, 955).mirror().addBox(-8.0f, -8.0f, -26.0f, 16, 16, 30), PartPose.offsetAndRotation(-54.0f, 16.0f, 6.0f, 0.0f, 0.7853982f, 0.0f));
        partdefinition.addOrReplaceChild("RToe6", CubeListBuilder.create().texOffs(92, 955).mirror().addBox(-8.0f, -8.0f, -26.0f, 16, 16, 36), PartPose.offsetAndRotation(-54.0f, 16.0f, 6.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("RToe5", CubeListBuilder.create().texOffs(0, 1002).mirror().addBox(-7.0f, -6.0f, -34.0f, 14, 14, 8), PartPose.offsetAndRotation(-54.0f, 16.0f, 6.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("RToe2", CubeListBuilder.create().texOffs(0, 1002).mirror().addBox(-7.0f, -6.0f, -34.0f, 14, 14, 8), PartPose.offsetAndRotation(-54.0f, 16.0f, 6.0f, 0.0f, -0.7853982f, 0.0f));
        partdefinition.addOrReplaceChild("RToe1", CubeListBuilder.create().texOffs(45, 1002).mirror().addBox(-5.0f, -2.0f, -40.0f, 10, 10, 6), PartPose.offsetAndRotation(-54.0f, 16.0f, 6.0f, 0.0f, -0.7853982f, 0.0f));
        partdefinition.addOrReplaceChild("RToe4", CubeListBuilder.create().texOffs(45, 1002).mirror().addBox(-5.0f, -2.0f, -40.0f, 10, 10, 6), PartPose.offsetAndRotation(-54.0f, 16.0f, 6.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("RToe7", CubeListBuilder.create().texOffs(45, 1002).mirror().addBox(-5.0f, -2.0f, -40.0f, 10, 10, 6), PartPose.offsetAndRotation(-54.0f, 16.0f, 6.0f, 0.0f, 0.7853982f, 0.0f));
        partdefinition.addOrReplaceChild("RToe8", CubeListBuilder.create().texOffs(0, 1002).mirror().addBox(-7.0f, -6.0f, -34.0f, 14, 14, 8), PartPose.offsetAndRotation(-54.0f, 16.0f, 6.0f, 0.0f, 0.7853982f, 0.0f));
        partdefinition.addOrReplaceChild("RToe3", CubeListBuilder.create().texOffs(0, 955).mirror().addBox(-8.0f, -8.0f, -26.0f, 16, 16, 30), PartPose.offsetAndRotation(-54.0f, 16.0f, 6.0f, 0.0f, -0.7853982f, 0.0f));
        partdefinition.addOrReplaceChild("LThigh", CubeListBuilder.create().texOffs(192, 350).mirror().addBox(0.0f, -14.0f, -21.0f, 28, 28, 42), PartPose.offsetAndRotation(40.0f, -91.0f, 2.0f, -0.5585054f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("LLowerLeg", CubeListBuilder.create().texOffs(202, 556).mirror().addBox(-15.0f, -62.0f, -15.0f, 30, 62, 30), PartPose.offsetAndRotation(54.0f, 14.0f, 6.0f, 0.1745329f, -0.1308997f, 0.0f));
        partdefinition.addOrReplaceChild("LUpperLeg", CubeListBuilder.create().texOffs(152, 420).mirror().addBox(-16.0f, -52.0f, -16.0f, 32, 52, 32), PartPose.offsetAndRotation(56.0f, -36.0f, -5.0f, -0.1745329f, -0.3926991f, -0.0872665f));
        partdefinition.addOrReplaceChild("TailTip", CubeListBuilder.create().texOffs(0, 694).mirror().addBox(-6.0f, 0.0f, -5.0f, 12, 21, 10), PartPose.offsetAndRotation(0.0f, 18.0f, 203.0f, 1.53589f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("RLegLower", CubeListBuilder.create().texOffs(200, 646).mirror().addBox(-15.0f, -62.0f, -15.0f, 30, 62, 30), PartPose.offsetAndRotation(-54.0f, 16.0f, 6.0f, 0.1745329f, 0.1308997f, 0.0f));
        partdefinition.addOrReplaceChild("RLegUpper", CubeListBuilder.create().texOffs(152, 420).mirror().addBox(-16.0f, -52.0f, -16.0f, 32, 52, 32), PartPose.offsetAndRotation(-56.0f, -36.0f, -5.0f, -0.1745329f, 0.3926991f, 0.0872665f));
        partdefinition.addOrReplaceChild("RThigh", CubeListBuilder.create().texOffs(192, 350).mirror().addBox(-28.0f, -14.0f, -21.0f, 28, 28, 42), PartPose.offsetAndRotation(-40.0f, -91.0f, 2.0f, -0.5585054f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("LowerJaw", CubeListBuilder.create().texOffs(272, 0).mirror().addBox(-13.0f, -5.0f, -50.0f, 26, 11, 50), PartPose.offsetAndRotation(0.0f, -142.0f, -109.0f, 0.5235988f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("TailBase", CubeListBuilder.create().texOffs(0, 240).mirror().addBox(-32.0f, 0.0f, -29.0f, 64, 40, 58), PartPose.offsetAndRotation(0.0f, -73.0f, 26.0f, 0.7853982f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(0, 338).mirror().addBox(-25.0f, 0.0f, -23.0f, 50, 36, 46), PartPose.offsetAndRotation(0.0f, -48.0f, 48.0f, 0.6981317f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Tail3", CubeListBuilder.create().texOffs(0, 420).mirror().addBox(-20.0f, 0.0f, -18.0f, 40, 36, 36), PartPose.offsetAndRotation(0.0f, -24.0f, 66.0f, 0.8726646f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Tail4", CubeListBuilder.create().texOffs(0, 492).mirror().addBox(-16.0f, 0.0f, -14.0f, 32, 42, 28), PartPose.offsetAndRotation(0.0f, -3.0f, 87.0f, 1.134464f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Tail5", CubeListBuilder.create().texOffs(0, 556).mirror().addBox(-13.0f, 0.0f, -11.0f, 26, 42, 22), PartPose.offsetAndRotation(0.0f, 12.0f, 116.0f, 1.53589f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Tail6", CubeListBuilder.create().texOffs(0, 614).mirror().addBox(-10.0f, 0.0f, -9.0f, 20, 32, 18), PartPose.offsetAndRotation(0.0f, 14.0f, 154.0f, 1.53589f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Tail7", CubeListBuilder.create().texOffs(0, 658).mirror().addBox(-8.0f, 0.0f, -7.0f, 16, 22, 14), PartPose.offsetAndRotation(0.0f, 16.0f, 185.0f, 1.53589f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("BodyBottom", CubeListBuilder.create().texOffs(0, 104).mirror().addBox(-40.0f, 0.0f, -36.0f, 80, 64, 72), PartPose.offsetAndRotation(0.0f, -112.0f, -20.0f, 0.8726646f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("RLowerArm", CubeListBuilder.create().texOffs(245, 240).mirror().addBox(-48.0f, -11.0f, -11.0f, 48, 22, 22), PartPose.offsetAndRotation(-80.0f, -115.0f, -61.0f, 0.0f, -0.7853982f, -0.2617994f));
        partdefinition.addOrReplaceChild("BodyCenter", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-36.0f, -32.0f, -32.0f, 72, 40, 64), PartPose.offsetAndRotation(0.0f, -112.0f, -20.0f, 1.134464f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 720).mirror().addBox(-23.0f, -23.0f, -32.0f, 46, 46, 32), PartPose.offsetAndRotation(0.0f, -144.0f, -71.0f, -0.0698132f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("TopJaw", CubeListBuilder.create().texOffs(0, 892).mirror().addBox(-14.0f, -8.0f, -73.0f, 28, 26, 33), PartPose.offsetAndRotation(0.0f, -156.0f, -98.0f, 0.0872665f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 808).mirror().addBox(-17.0f, -18.0f, -40.0f, 34, 36, 40), PartPose.offsetAndRotation(0.0f, -156.0f, -98.0f, 0.0872665f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("BodyTop", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-36.0f, -32.0f, -32.0f, 72, 40, 64), PartPose.offsetAndRotation(0.0f, -126.0f, -50.0f, 1.308997f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("RShoulder", CubeListBuilder.create().texOffs(304, 96).mirror().addBox(-16.0f, -32.0f, -32.0f, 16, 42, 46), PartPose.offsetAndRotation(-36.0f, -130.0f, -42.0f, 1.308997f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("RThumbTip", CubeListBuilder.create().texOffs(422, 18).mirror().addBox(5.0f, 1.0f, -43.0f, 8, 8, 12), PartPose.offsetAndRotation(-115.0f, -100.0f, -99.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("RUpperArm", CubeListBuilder.create().texOffs(304, 184).mirror().addBox(-54.0f, -13.0f, -13.0f, 54, 26, 26), PartPose.offsetAndRotation(-38.0f, -130.0f, -52.0f, 0.0f, -0.2617994f, -0.3490659f));
        partdefinition.addOrReplaceChild("RHand", CubeListBuilder.create().texOffs(245, 292).mirror().addBox(-13.0f, -13.0f, -13.0f, 26, 26, 26), PartPose.offsetAndRotation(-115.0f, -100.0f, -99.0f, -1.071467f, 2.007129f, 0.1745329f));
        partdefinition.addOrReplaceChild("RThumbBase", CubeListBuilder.create().texOffs(424, 57).mirror().addBox(2.0f, 1.0f, -32.0f, 8, 8, 20), PartPose.offsetAndRotation(-115.0f, -100.0f, -99.0f, 0.0f, -0.1047198f, 0.0f));
        partdefinition.addOrReplaceChild("R3rdFingerTip", CubeListBuilder.create().texOffs(422, 18).mirror().addBox(-10.0f, 0.0f, -41.0f, 8, 8, 12), PartPose.offsetAndRotation(-115.0f, -100.0f, -99.0f, 0.0f, 0.6806784f, 0.0f));
        partdefinition.addOrReplaceChild("R3rdFingerBase", CubeListBuilder.create().texOffs(424, 57).mirror().addBox(-11.0f, -3.0f, -30.0f, 8, 8, 20), PartPose.offsetAndRotation(-115.0f, -100.0f, -99.0f, 0.122173f, 0.6457718f, 0.0f));
        partdefinition.addOrReplaceChild("RIndexTip", CubeListBuilder.create().texOffs(422, 18).mirror().addBox(-4.0f, -12.0f, -43.0f, 8, 8, 12), PartPose.offsetAndRotation(-115.0f, -100.0f, -99.0f, -0.2094395f, 0.1745329f, 0.0f));
        partdefinition.addOrReplaceChild("RIndexBase", CubeListBuilder.create().texOffs(424, 57).mirror().addBox(-4.0f, -9.0f, -34.0f, 8, 8, 20), PartPose.offsetAndRotation(-115.0f, -100.0f, -99.0f, -0.2792527f, 0.1570796f, 0.0f));
        partdefinition.addOrReplaceChild("LShoulder", CubeListBuilder.create().texOffs(304, 96).mirror().addBox(0.0f, -32.0f, -32.0f, 16, 42, 46), PartPose.offsetAndRotation(36.0f, -130.0f, -42.0f, 1.308997f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("LUpperArm", CubeListBuilder.create().texOffs(304, 184).mirror().addBox(0.0f, -13.0f, -13.0f, 54, 26, 26), PartPose.offsetAndRotation(38.0f, -130.0f, -52.0f, 0.0f, 0.296706f, 0.3490659f));
        partdefinition.addOrReplaceChild("LLowerArm", CubeListBuilder.create().texOffs(245, 240).mirror().addBox(0.0f, -11.0f, -11.0f, 48, 22, 22), PartPose.offsetAndRotation(80.0f, -115.0f, -61.0f, 0.0f, 0.7853982f, 0.2617994f));
        partdefinition.addOrReplaceChild("LIndexBase", CubeListBuilder.create().texOffs(424, 57).mirror().addBox(-4.0f, -13.0f, -32.0f, 8, 8, 20), PartPose.offsetAndRotation(115.0f, -100.0f, -99.0f, -0.1570796f, -0.1396263f, 0.0f));
        partdefinition.addOrReplaceChild("LIndexTip", CubeListBuilder.create().texOffs(422, 18).mirror().addBox(-1.0f, -18.0f, -41.0f, 8, 8, 12), PartPose.offsetAndRotation(115.0f, -100.0f, -99.0f, 0.0f, -0.0349066f, 0.0f));
        partdefinition.addOrReplaceChild("LHand", CubeListBuilder.create().texOffs(245, 292).mirror().addBox(-13.0f, -13.0f, -13.0f, 26, 26, 26), PartPose.offsetAndRotation(115.0f, -100.0f, -99.0f, 0.9599311f, 1.308997f, 0.1745329f));
        partdefinition.addOrReplaceChild("LThumbBase", CubeListBuilder.create().texOffs(424, 57).mirror().addBox(-8.0f, -2.0f, -32.0f, 8, 8, 20), PartPose.offsetAndRotation(115.0f, -100.0f, -98.0f, 0.1396263f, 0.2617994f, 0.0f));
        partdefinition.addOrReplaceChild("LThumbTip", CubeListBuilder.create().texOffs(422, 18).mirror().addBox(-12.0f, 2.0f, -40.0f, 8, 8, 12), PartPose.offsetAndRotation(115.0f, -100.0f, -99.0f, 0.0f, 0.1396263f, 0.0f));
        partdefinition.addOrReplaceChild("L3rdFingerTip", CubeListBuilder.create().texOffs(422, 18).mirror().addBox(9.0f, 2.0f, -42.0f, 8, 8, 12), PartPose.offsetAndRotation(115.0f, -100.0f, -99.0f, 0.0349066f, -0.3316126f, 0.0f));
        partdefinition.addOrReplaceChild("L3rdFingerBase", CubeListBuilder.create().texOffs(424, 57).mirror().addBox(4.0f, -5.0f, -33.0f, 8, 8, 20), PartPose.offsetAndRotation(115.0f, -100.0f, -99.0f, 0.2617994f, -0.4712389f, 0.0f));
        partdefinition.addOrReplaceChild("Lspikes1", CubeListBuilder.create().texOffs(500, 0).mirror().addBox(0.0f, -10.0f, 0.0f, 0, 10, 11), PartPose.offsetAndRotation(5.0f, -168.0f, -86.0f, -0.0872665f, 0.0f, -0.0174533f));
        partdefinition.addOrReplaceChild("Rspikes1", CubeListBuilder.create().texOffs(500, 0).mirror().addBox(0.0f, -10.0f, 0.0f, 0, 10, 11), PartPose.offsetAndRotation(-5.0f, -168.0f, -86.0f, -0.0872665f, 0.0f, -0.0174533f));
        partdefinition.addOrReplaceChild("Lspike2", CubeListBuilder.create().texOffs(500, 30).mirror().addBox(0.0f, -25.0f, 0.0f, 0, 25, 21), PartPose.offsetAndRotation(10.0f, -162.0f, -63.0f, -0.2617994f, 0.0f, -0.0174533f));
        partdefinition.addOrReplaceChild("Rspike2", CubeListBuilder.create().texOffs(500, 30).mirror().addBox(0.0f, -25.0f, 0.0f, 0, 25, 21), PartPose.offsetAndRotation(-10.0f, -162.0f, -63.0f, -0.2617994f, 0.0f, -0.0174533f));
        partdefinition.addOrReplaceChild("Lspike3", CubeListBuilder.create().texOffs(500, 80).mirror().addBox(0.0f, -45.0f, 0.0f, 0, 45, 34), PartPose.offsetAndRotation(14.0f, -153.0f, -32.0f, -0.4363323f, 0.0f, -0.0174533f));
        partdefinition.addOrReplaceChild("Rspike3", CubeListBuilder.create().texOffs(500, 80).mirror().addBox(0.0f, -45.0f, 0.0f, 0, 45, 34), PartPose.offsetAndRotation(-14.0f, -153.0f, -32.0f, -0.4363323f, 0.0f, -0.0174533f));
        partdefinition.addOrReplaceChild("Lspike4", CubeListBuilder.create().texOffs(500, 165).mirror().addBox(0.0f, -50.0f, 0.0f, 0, 50, 36), PartPose.offsetAndRotation(18.0f, -131.0f, 13.0f, -0.715585f, 0.0f, -0.0174533f));
        partdefinition.addOrReplaceChild("Rspike4", CubeListBuilder.create().texOffs(500, 165).mirror().addBox(0.0f, -50.0f, 0.0f, 0, 50, 36), PartPose.offsetAndRotation(-18.0f, -131.0f, 13.0f, -0.715585f, 0.0f, -0.0174533f));
        partdefinition.addOrReplaceChild("Lspike5", CubeListBuilder.create().texOffs(500, 255).mirror().addBox(12.0f, -67.0f, 5.0f, 0, 39, 27), PartPose.offsetAndRotation(0.0f, -73.0f, 26.0f, -0.7853982f, 0.0f, -0.0174533f));
        partdefinition.addOrReplaceChild("Rspike5", CubeListBuilder.create().texOffs(500, 255).mirror().addBox(-12.0f, -67.0f, 5.0f, 0, 39, 27), PartPose.offsetAndRotation(0.0f, -73.0f, 26.0f, -0.7853982f, 0.0f, -0.0174533f));
        partdefinition.addOrReplaceChild("Spike6", CubeListBuilder.create().texOffs(500, 325).mirror().addBox(0.0f, -48.0f, 11.0f, 0, 25, 21), PartPose.offsetAndRotation(0.0f, -48.0f, 48.0f, -0.8901179f, 0.0f, -0.0174533f));
        partdefinition.addOrReplaceChild("Spikes7", CubeListBuilder.create().texOffs(500, 376).mirror().addBox(0.0f, -29.0f, 20.0f, 0, 10, 11), PartPose.offsetAndRotation(0.0f, -24.0f, 66.0f, -0.7504916f, 0.0f, -0.0174533f));
