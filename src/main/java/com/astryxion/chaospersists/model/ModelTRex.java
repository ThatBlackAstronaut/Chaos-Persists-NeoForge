...
public class ModelTRex extends EntityModel<TRex> {
    ...
    public static MeshDefinition createMesh() {
        ...
        partdefinition.addOrReplaceChild("Shape18", CubeListBuilder.create().texOffs(91, 114).addBox(0.0f, 0.0f, 0.0f, 2, 4, 5), PartPose.offsetAndRotation(3.3f, -25.0f, -23.0f, 0.5759587f, 0.0f, 0.5585054f));
        partdefinition.addOrReplaceChild("Shape19", CubeListBuilder.create().texOffs(71, 114).addBox(0.0f, 0.0f, 0.0f, 2, 4, 5), PartPose.offsetAndRotation(-4.0f, -24.0f, -23.0f, 0.5759587f, 0.0f, -0.5585054f));
        ...
        partdefinition.addOrReplaceChild("Shape1", CubeListBuilder.create().texOffs(0, 0).addBox(-7.0f, 0.0f, 0.0f, 10, 18, 31), PartPose.offset(2.5f, -19.0f, -8.0f));
        partdefinition.addOrReplaceChild("Shape2", CubeListBuilder.create().texOffs(62, 0).addBox(-5.0f, 0.0f, 0.0f, 10, 11, 11), PartPose.offset(0.5f, -19.0f, 23.0f));
        partdefinition.addOrReplaceChild("Shape3", CubeListBuilder.create().texOffs(10, 54).addBox(-3.0f, 0.0f, 0.0f, 7, 7, 25), PartPose.offset(0.0f, -19.0f, 34.0f));
        ...
        partdefinition.addOrReplaceChild("Shape5", CubeListBuilder.create().texOffs(75, 65).addBox(0.0f, 0.0f, 0.0f, 9, 9, 12), PartPose.offset(-4.0f, -25.0f, -27.0f));
        partdefinition.addOrReplaceChild("Shape6", CubeListBuilder.create().texOffs(0, 50).addBox(0.0f, 0.0f, 0.0f, 7, 9, 9), PartPose.offset(-3.0f, -25.0f, -36.0f));
        ...
        partdefinition.addOrReplaceChild("leftleg4", CubeListBuilder.create().texOffs(42, 113).addBox(-1.0f, 31.0f, -1.0f, 3, 3, 8), PartPose.offset(6.0f, -10.0f, 11.0f));
        partdefinition.addOrReplaceChild("rightleg4", CubeListBuilder.create().texOffs(44, 93).addBox(0.0f, 31.0f, -1.0f, 3, 3, 8), PartPose.offset(-7.0f, -10.0f, 11.0f));
        ...
        partdefinition.addOrReplaceChild("TailExtension", CubeListBuilder.create().texOffs(0, 10).addBox(0.0f, 0.0f, 0.0f, 3, 3, 10), PartPose.offset(-1.0f, -19.0f, 59.0f));
        partdefinition.addOrReplaceChild("Spine1", CubeListBuilder.create().texOffs(73, 0).addBox(0.0f, 0.0f, 0.0f, 2, 2, 3), PartPose.offset(-1.0f, -21.0f, 0.0f));
        partdefinition.addOrReplaceChild("Spine2", CubeListBuilder.create().texOffs(73, 0).addBox(0.0f, 0.0f, 0.0f, 2, 2, 3), PartPose.offset(-0.5f, -21.0f, 6.0f));
        partdefinition.addOrReplaceChild("Spine3", CubeListBuilder.create().texOffs(73, 0).addBox(0.0f, 0.0f, 0.0f, 2, 2, 3), PartPose.offset(-0.5f, -21.0f, 12.0f));
        partdefinition.addOrReplaceChild("Spine4", CubeListBuilder.create().texOffs(73, 0).addBox(0.0f, 0.0f, 0.0f, 2, 2, 3), PartPose.offsetAndRotation(-0.5f, -24.0f, -9.0f, -0.4014257f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Spine5", CubeListBuilder.create().texOffs(73, 0).addBox(0.0f, 0.0f, 0.0f, 2, 2, 3), PartPose.offsetAndRotation(-0.5f, -26.0f, -14.0f, -0.4014257f, 0.0f, 0.0f));
