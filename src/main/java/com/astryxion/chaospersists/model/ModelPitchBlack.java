...
public class ModelPitchBlack extends EntityModel<PitchBlack> {
    ...
    private static MeshDefinition createMesh() {
        ...
        root.addOrReplaceChild("lclaw1", CubeListBuilder.create().texOffs(300, 111).addBox(-3.0f, 0.0f, -3.0f, 2, 3, 6), PartPose.offsetAndRotation(7.0f, 21.0f, 11.0f, 0.0f, 0.6632251f, 0.0f));
        root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(400, 26).addBox(-6.0f, -12.0f, -9.0f, 12, 12, 9), PartPose.offsetAndRotation(0.0f, 0.0f, 9.0f, 0.0698132f, 0.0f, 0.0f));
        root.addOrReplaceChild("leftleg1", CubeListBuilder.create().texOffs(300, 10).addBox(-1.0f, -5.0f, -20.0f, 5, 10, 10), PartPose.offsetAndRotation(7.0f, 5.0f, 23.0f, -0.5759587f, 0.0f, 0.0f));
        root.addOrReplaceChild("tail1", CubeListBuilder.create().texOffs(400, 82).addBox(-5.0f, -6.0f, 0.0f, 8, 10, 12), PartPose.offsetAndRotation(1.0f, -3.0f, 22.0f, -0.1745329f, 0.0f, 0.0f));
        root.addOrReplaceChild("leftleg2", CubeListBuilder.create().texOffs(300, 31).addBox(-1.0f, -10.0f, -4.0f, 4, 12, 5), PartPose.offsetAndRotation(7.0f, 5.0f, 23.0f, 0.9773844f, 0.0f, 0.0f));
        root.addOrReplaceChild("body2", CubeListBuilder.create().texOffs(400, 50).addBox(0.0f, -3.0f, -3.0f, 12, 14, 16), PartPose.offsetAndRotation(-6.0f, -9.0f, 10.0f, -0.1047198f, 0.0f, 0.0f));
        root.addOrReplaceChild("leftleg3", CubeListBuilder.create().texOffs(300, 51).addBox(-1.0f, -19.0f, 1.0f, 3, 18, 4), PartPose.offsetAndRotation(7.0f, 21.0f, 11.0f, -0.5235988f, 0.0f, 0.0f));
        root.addOrReplaceChild("tail2", CubeListBuilder.create().texOffs(400, 106).addBox(-3.0f, -4.0f, 0.0f, 6, 8, 10), PartPose.offsetAndRotation(0.0f, -2.0f, 33.0f, -0.1396263f, 0.0f, 0.0f));
        root.addOrReplaceChild("tail3", CubeListBuilder.create().texOffs(400, 126).addBox(-2.0f, -2.0f, 0.0f, 4, 5, 10), PartPose.offsetAndRotation(0.0f, -1.0f, 42.0f, -0.1396263f, 0.0f, 0.0f));
        root.addOrReplaceChild("lclaw2", CubeListBuilder.create().texOffs(300, 76).addBox(-1.0f, -1.0f, -6.0f, 3, 4, 13), PartPose.offset(7.0f, 21.0f, 11.0f));
        root.addOrReplaceChild("lclaw3", CubeListBuilder.create().texOffs(300, 95).addBox(2.0f, 0.0f, -6.0f, 2, 3, 10), PartPose.offsetAndRotation(7.0f, 21.0f, 11.0f, 0.0f, -0.6632251f, 0.0f));
        root.addOrReplaceChild("lclaw4", CubeListBuilder.create().texOffs(310, 123).addBox(0.0f, 1.0f, -9.0f, 1, 2, 3), PartPose.offset(7.0f, 21.0f, 11.0f));
        root.addOrReplaceChild("lclaw5", CubeListBuilder.create().texOffs(300, 123).addBox(-2.5f, 1.0f, -5.0f, 1, 2, 2), PartPose.offsetAndRotation(7.0f, 21.0f, 11.0f, 0.0f, 0.6632251f, 0.0f));
        root.addOrReplaceChild("lclaw6", CubeListBuilder.create().texOffs(322, 123).addBox(2.5f, 1.0f, -9.0f, 1, 2, 3), PartPose.offsetAndRotation(7.0f, 21.0f, 11.0f, 0.0f, -0.6632251f, 0.0f));
        root.addOrReplaceChild("lclaw7", CubeListBuilder.create().texOffs(333, 123).addBox(0.0f, 1.0f, 7.0f, 1, 2, 3), PartPose.offset(7.0f, 21.0f, 11.0f));
        root.addOrReplaceChild("tail4", CubeListBuilder.create().texOffs(400, 143).addBox(-2.0f, -2.0f, 0.0f, 4, 4, 10), PartPose.offsetAndRotation(0.0f, 0.0f, 51.0f, -0.1396263f, 0.0f, 0.0f));
        root.addOrReplaceChild("tail5", CubeListBuilder.create().texOffs(400, 159).addBox(-1.5f, -2.0f, 0.0f, 3, 3, 10), PartPose.offsetAndRotation(0.0f, 1.0f, 59.0f, -0.1396263f, 0.0f, 0.0f));
        root.addOrReplaceChild("tail6", CubeListBuilder.create().texOffs(400, 180).addBox(0.0f, 0.0f, 0.0f, 2, 2, 10), PartPose.offsetAndRotation(0.0f, 0.0f, 68.0f, -0.1396263f, 0.1745329f, 0.0f));
        root.addOrReplaceChild("tail7", CubeListBuilder.create().texOffs(400, 180).addBox(-2.0f, 0.0f, 0.0f, 2, 2, 10), PartPose.offsetAndRotation(0.0f, 0.0f, 68.0f, -0.1396263f, -0.1745329f, 0.0f));
        root.addOrReplaceChild("tail8", CubeListBuilder.create().texOffs(400, 180).addBox(0.0f, 0.0f, 0.0f, 2, 2, 10), PartPose.offsetAndRotation(-4.0f, 1.0f, 77.0f, -0.1396263f, -0.1745329f, 0.0f));
        root.addOrReplaceChild("tail9", CubeListBuilder.create().texOffs(400, 180).addBox(0.0f, 0.0f, 0.0f, 2, 2, 10), PartPose.offsetAndRotation(2.0f, 1.0f, 77.0f, -0.1396263f, 0.1745329f, 0.0f));
        root.addOrReplaceChild("tailpoint1", CubeListBuilder.create().texOffs(400, 200).addBox(-1.0f, -1.0f, 0.0f, 1, 1, 22), PartPose.offsetAndRotation(5.0f, 3.0f, 85.0f, -0.1919862f, 0.1745329f, 0.0f));
        root.addOrReplaceChild("tailpoint2", CubeListBuilder.create().texOffs(400, 200).addBox(-1.0f, -1.0f, 0.0f, 1, 1, 22), PartPose.offsetAndRotation(-4.0f, 3.0f, 86.0f, -0.1919862f, -0.1745329f, 0.0f));
        root.addOrReplaceChild("llegspike", CubeListBuilder.create().texOffs(300, 131).addBox(0.0f, -28.0f, 1.0f, 1, 12, 1), PartPose.offsetAndRotation(7.0f, 21.0f, 11.0f, -0.6981317f, 0.0f, 0.0f));
        root.addOrReplaceChild("tailspike1", CubeListBuilder.create().texOffs(400, 230).addBox(1.0f, -1.0f, 0.0f, 1, 1, 1), PartPose.offsetAndRotation(2.0f, 1.0f, 77.0f, -0.1396263f, 0.1745329f, 0.0f));
        root.addOrReplaceChild("tailspike2", CubeListBuilder.create().texOffs(400, 230).addBox(1.0f, -1.0f, 6.0f, 1, 1, 1), PartPose.offsetAndRotation(0.0f, 0.0f, 68.0f, -0.1396263f, 0.1745329f, 0.0f));
        root.addOrReplaceChild("tailspike3", CubeListBuilder.create().texOffs(400, 230).addBox(1.0f, -1.0f, 2.0f, 1, 1, 1), PartPose.offsetAndRotation(0.0f, 0.0f, 68.0f, -0.1396263f, 0.1745329f, 0.0f));
        root.addOrReplaceChild("tailspike4", CubeListBuilder.create().texOffs(400, 230).addBox(0.0f, -1.0f, 0.0f, 1, 1, 1), PartPose.offsetAndRotation(-4.0f, 1.0f, 77.0f, -0.1396263f, -0.1745329f, 0.0f));
        root.addOrReplaceChild("tailspike5", CubeListBuilder.create().texOffs(400, 230).addBox(-2.0f, -1.0f, 6.0f, 1, 1, 1), PartPose.offsetAndRotation(0.0f, 0.0f, 68.0f, -0.1396263f, -0.1745329f, 0.0f));
        root.addOrReplaceChild("tailspike6", CubeListBuilder.create().texOffs(400, 230).addBox(-2.0f, -1.0f, 2.0f, 1, 1, 1), PartPose.offsetAndRotation(0.0f, 0.0f, 68.0f, -0.1396263f, -0.1745329f, 0.0f));
        root.addOrReplaceChild("neck1", CubeListBuilder.create().texOffs(400, 7).addBox(-4.0f, -4.0f, 0.0f, 8, 8, 8), PartPose.offsetAndRotation(0.0f, -4.0f, -5.0f, 0.0872665f, 0.0f, 0.0f));
        root.addOrReplaceChild("neck2", CubeListBuilder.create().texOffs(375, 10).addBox(-3.0f, -3.0f, -3.0f, 6, 6, 4), PartPose.offsetAndRotation(0.0f, -4.0f, -5.0f, -0.0523599f, 0.0f, 0.0f));
        root.addOrReplaceChild("neck3", CubeListBuilder.create().texOffs(375, 23).addBox(-2.0f, -2.0f, -6.0f, 4, 4, 8), PartPose.offsetAndRotation(0.0f, -4.0f, -9.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("head1", CubeListBuilder.create().texOffs(123, 3).addBox(-18.0f, -1.0f, -12.0f, 36, 1, 12), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("leye", CubeListBuilder.create().texOffs(76, 2).addBox(18.0f, -1.0f, -13.0f, 3, 3, 15), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("reye", CubeListBuilder.create().texOffs(32, 2).addBox(-21.0f, -1.0f, -13.0f, 3, 3, 15), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("head2", CubeListBuilder.create().texOffs(140, 18).addBox(-8.0f, -2.0f, -11.0f, 16, 1, 11), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("head3", CubeListBuilder.create().texOffs(143, 32).addBox(-2.0f, -4.0f, -14.0f, 4, 4, 16), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("head4", CubeListBuilder.create().texOffs(152, 55).addBox(-1.0f, -10.0f, -13.0f, 2, 8, 12), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.3665191f, 0.0f, 0.0f));
        root.addOrReplaceChild("head5", CubeListBuilder.create().texOffs(154, 77).addBox(-0.5f, -18.0f, -11.0f, 1, 9, 9), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.4363323f, 0.0f, 0.0f));
        root.addOrReplaceChild("head6", CubeListBuilder.create().texOffs(160, 97).addBox(-0.5f, -24.0f, -10.0f, 1, 8, 4), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.6632251f, 0.0f, 0.0f));
        root.addOrReplaceChild("jaw1", CubeListBuilder.create().texOffs(143, 114).addBox(-2.0f, 1.0f, -14.0f, 4, 4, 15), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("jaw2", CubeListBuilder.create().texOffs(150, 149).addBox(-1.0f, 4.0f, -12.0f, 2, 5, 11), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.2617994f, 0.0f, 0.0f));
        root.addOrReplaceChild("jaw3", CubeListBuilder.create().texOffs(154, 168).addBox(-0.5f, 8.0f, -10.0f, 1, 4, 8), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.3316126f, 0.0f, 0.0f));
        root.addOrReplaceChild("jaw4", CubeListBuilder.create().texOffs(158, 182).addBox(-0.5f, 11.0f, -7.0f, 1, 4, 4), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.4014257f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth1", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0f, 0.0f, -14.0f, 1, 3, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth2", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5f, 0.0f, -14.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth3", CubeListBuilder.create().texOffs(0, 0).addBox(1.0f, 0.0f, -14.0f, 1, 3, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth4", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0f, 0.0f, -12.0f, 1, 3, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth5", CubeListBuilder.create().texOffs(0, 0).addBox(1.0f, 0.0f, -12.0f, 1, 3, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("jaw5", CubeListBuilder.create().texOffs(151, 135).addBox(-3.0f, 1.0f, -4.0f, 6, 5, 7), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("head7", CubeListBuilder.create().texOffs(185, 34).addBox(-3.0f, -5.0f, -3.0f, 6, 5, 7), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth6", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0f, 0.0f, -10.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth7", CubeListBuilder.create().texOffs(0, 0).addBox(1.0f, 0.0f, -10.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth8", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0f, 0.0f, -8.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth9", CubeListBuilder.create().texOffs(0, 0).addBox(1.0f, 0.0f, -8.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth10", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0f, 0.0f, -6.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth11", CubeListBuilder.create().texOffs(0, 0).addBox(1.0f, 0.0f, -6.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth12", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0f, 0.0f, -4.0f, 1, 1, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth13", CubeListBuilder.create().texOffs(-1, 0).addBox(1.0f, 0.0f, -4.0f, 1, 1, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, -0.2443461f, 0.0f, 0.0f));
        root.addOrReplaceChild("rightleg1", CubeListBuilder.create().texOffs(250, 10).addBox(-1.0f, -5.0f, -20.0f, 5, 10, 10), PartPose.offsetAndRotation(-10.0f, 5.0f, 23.0f, -0.5934119f, 0.0f, 0.0f));
        root.addOrReplaceChild("rightleg2", CubeListBuilder.create().texOffs(250, 32).addBox(0.0f, -10.0f, -4.0f, 4, 12, 5), PartPose.offsetAndRotation(-10.0f, 5.0f, 23.0f, 0.9773844f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth14", CubeListBuilder.create().texOffs(0, 0).addBox(0.5f, -2.0f, -14.0f, 1, 3, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth15", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5f, -2.0f, -14.0f, 1, 3, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth16", CubeListBuilder.create().texOffs(0, 0).addBox(1.0f, -1.0f, -12.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth17", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0f, -1.0f, -12.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth18", CubeListBuilder.create().texOffs(0, 0).addBox(1.0f, -1.0f, -10.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth19", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0f, -1.0f, -10.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth20", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0f, -1.0f, -8.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth21", CubeListBuilder.create().texOffs(0, 0).addBox(1.0f, -1.0f, -8.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth22", CubeListBuilder.create().texOffs(0, 0).addBox(1.0f, 0.0f, -6.0f, 1, 1, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("tooth23", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0f, 0.0f, -6.0f, 1, 1, 1), PartPose.offsetAndRotation(0.0f, -6.0f, -14.0f, 0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("rightleg3", CubeListBuilder.create().texOffs(250, 52).addBox(-1.0f, -19.0f, 1.0f, 3, 18, 4), PartPose.offsetAndRotation(-8.0f, 21.0f, 11.0f, -0.5235988f, 0.0f, 0.0f));
        root.addOrReplaceChild("llegspike2", CubeListBuilder.create().texOffs(250, 130).addBox(0.0f, -28.0f, 1.0f, 1, 12, 1), PartPose.offsetAndRotation(-8.0f, 21.0f, 11.0f, -0.6981317f, 0.0f, 0.0f));
        root.addOrReplaceChild("rclaw2", CubeListBuilder.create().texOffs(250, 76).addBox(-1.0f, -1.0f, -6.0f, 3, 4, 13), PartPose.offset(-8.0f, 21.0f, 11.0f));
        root.addOrReplaceChild("rclaw4", CubeListBuilder.create().texOffs(250, 123).addBox(0.0f, 1.0f, -9.0f, 1, 2, 3), PartPose.offset(-8.0f, 21.0f, 11.0f));
        root.addOrReplaceChild("rclaw1", CubeListBuilder.create().texOffs(250, 111).addBox(2.0f, 0.0f, -4.0f, 2, 3, 6), PartPose.offsetAndRotation(-8.0f, 21.0f, 11.0f, 0.0f, -0.6632251f, 0.0f));
        root.addOrReplaceChild("rclaw5", CubeListBuilder.create().texOffs(261, 123).addBox(2.5f, 1.0f, -6.0f, 1, 2, 2), PartPose.offsetAndRotation(-8.0f, 21.0f, 11.0f, 0.0f, -0.6632251f, 0.0f));
        root.addOrReplaceChild("rclaw7", CubeListBuilder.create().texOffs(283, 123).addBox(0.0f, 1.0f, 7.0f, 1, 2, 3), PartPose.offset(-8.0f, 21.0f, 11.0f));
        root.addOrReplaceChild("rclaw3", CubeListBuilder.create().texOffs(250, 95).addBox(-3.0f, 0.0f, -6.0f, 2, 3, 10), PartPose.offsetAndRotation(-8.0f, 21.0f, 11.0f, 0.0f, 0.6632251f, 0.0f));
        root.addOrReplaceChild("rclaw6", CubeListBuilder.create().texOffs(270, 123).addBox(-2.5f, 1.0f, -9.0f, 1, 2, 3), PartPose.offsetAndRotation(-8.0f, 21.0f, 11.0f, 0.0f, 0.6632251f, 0.0f));
        root.addOrReplaceChild("wing1", CubeListBuilder.create().texOffs(10, 30).addBox(-1.0f, -1.0f, -1.0f, 23, 3, 3), PartPose.offsetAndRotation(6.0f, -12.0f, 3.0f, 0.0f, 0.0872665f, -0.1396263f));
        root.addOrReplaceChild("wing2", CubeListBuilder.create().texOffs(10, 40).addBox(-1.0f, -1.0f, -1.0f, 44, 2, 2), PartPose.offset(27.0f, -15.0f, 1.0f));
        root.addOrReplaceChild("wing3", CubeListBuilder.create().texOffs(10, 50).addBox(-1.0f, -1.0f, -1.0f, 23, 2, 2), PartPose.offsetAndRotation(70.0f, -15.0f, 1.0f, 0.0f, -0.0872665f, 0.1745329f));
        root.addOrReplaceChild("mem1", CubeListBuilder.create().texOffs(10, 60).addBox(-2.0f, 0.0f, 0.0f, 24, 1, 21), PartPose.offsetAndRotation(6.0f, -12.0f, 3.0f, 0.0f, 0.0872665f, -0.1396263f));
        root.addOrReplaceChild("mem2", CubeListBuilder.create().texOffs(10, 85).addBox(0.0f, 0.0f, 0.0f, 43, 1, 21), PartPose.offset(27.0f, -15.0f, 1.0f));
        root.addOrReplaceChild("mem3", CubeListBuilder.create().texOffs(10, 110).addBox(0.0f, 0.0f, 0.0f, 23, 1, 21), PartPose.offsetAndRotation(70.0f, -15.0f, 1.0f, 0.0f, -0.0872665f, 0.1745329f));
        root.addOrReplaceChild("wingclaw1", CubeListBuilder.create().texOffs(85, 49).addBox(0.0f, 0.0f, -9.0f, 1, 1, 8), PartPose.offset(70.0f, -15.0f, 1.0f));
        root.addOrReplaceChild("wingclaw2", CubeListBuilder.create().texOffs(67, 50).addBox(0.0f, 0.0f, -7.0f, 1, 1, 6), PartPose.offsetAndRotation(70.0f, -15.0f, 1.0f, 0.0f, 0.6108652f, 0.0f));
        root.addOrReplaceChild("wingclaw3", CubeListBuilder.create().texOffs(106, 50).addBox(1.0f, 0.0f, -7.0f, 1, 1, 5), PartPose.offsetAndRotation(69.0f, -15.0f, 1.0f, 0.0f, -0.6108652f, 0.0f));
        root.addOrReplaceChild("lshoulder", CubeListBuilder.create().texOffs(370, 40).addBox(0.0f, 0.0f, 0.0f, 3, 2, 6), PartPose.offsetAndRotation(3.0f, -13.0f, 1.0f, 0.0698132f, 0.0f, 0.0f));
        root.addOrReplaceChild("rshoulder", CubeListBuilder.create().texOffs(370, 50).addBox(0.0f, 0.0f, 0.0f, 3, 2, 6), PartPose.offsetAndRotation(-6.0f, -13.0f, 1.0f, 0.0698132f, 0.0f, 0.0f));
        root.addOrReplaceChild("rwing1", CubeListBuilder.create().texOffs(10, 140).addBox(-22.0f, -1.0f, -1.0f, 23, 3, 3), PartPose.offsetAndRotation(-6.0f, -12.0f, 3.0f, 0.0f, -0.0872665f, 0.1396263f));
        root.addOrReplaceChild("rmem1", CubeListBuilder.create().texOffs(10, 170).addBox(-22.0f, 0.0f, 0.0f, 24, 1, 21), PartPose.offsetAndRotation(-6.0f, -12.0f, 3.0f, 0.0f, -0.0872665f, 0.1396263f));
        root.addOrReplaceChild("rwing2", CubeListBuilder.create().texOffs(10, 150).addBox(-43.0f, -1.0f, -1.0f, 44, 2, 2), PartPose.offset(-27.0f, -15.0f, 1.0f));
        root.addOrReplaceChild("rmem2", CubeListBuilder.create().texOffs(10, 195).addBox(-43.0f, 0.0f, 0.0f, 43, 1, 21), PartPose.offset(-27.0f, -15.0f, 1.0f));
        root.addOrReplaceChild("rwing3", CubeListBuilder.create().texOffs(10, 160).addBox(-22.0f, -1.0f, -1.0f, 23, 2, 2), PartPose.offsetAndRotation(-70.0f, -15.0f, 1.0f, 0.0f, 0.0872665f, -0.1745329f));
        root.addOrReplaceChild("rmem3", CubeListBuilder.create().texOffs(10, 220).addBox(-23.0f, 0.0f, 0.0f, 23, 1, 21), PartPose.offsetAndRotation(-70.0f, -15.0f, 1.0f, 0.0f, 0.0872665f, -0.1745329f));
        root.addOrReplaceChild("rwingclaw1", CubeListBuilder.create().texOffs(81, 157).addBox(0.0f, 0.0f, -9.0f, 1, 1, 8), PartPose.offset(-70.0f, -15.0f, 1.0f));
        root.addOrReplaceChild("rwingclaw2", CubeListBuilder.create().texOffs(64, 160).addBox(0.0f, 0.0f, -7.0f, 1, 1, 6), PartPose.offsetAndRotation(-70.0f, -15.0f, 1.0f, 0.0f, -0.6108652f, 0.0f));
        root.addOrReplaceChild("rwingclaw3", CubeListBuilder.create().texOffs(103, 159).addBox(0.0f, 0.0f, -6.0f, 1, 1, 5), PartPose.offsetAndRotation(-70.0f, -15.0f, 1.0f, 0.0f, 0.6108652f, 0.0f));
        return mesh;
    }
