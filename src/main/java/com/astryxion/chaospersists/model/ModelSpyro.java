...
public class ModelSpyro extends EntityModel<Spyro> {
    ...
    private static MeshDefinition createMesh() {
        ...
        root.addOrReplaceChild("RightFrontPaw", CubeListBuilder.create().texOffs(12, 31).mirror().addBox(0.0f, 5.0f, -4.0f, 2, 1, 4), PartPose.offset(3.0f, 18.0f, -2.0f));
        ...
        root.addOrReplaceChild("LegRightFrontTop", CubeListBuilder.create().texOffs(20, 19).mirror().addBox(0.0f, 0.0f, -2.0f, 2, 3, 3), PartPose.offsetAndRotation(3.0f, 18.0f, -2.0f, -0.0872665f, 0.0f, 0.0f));
        root.addOrReplaceChild("LegRightFrontBottom", CubeListBuilder.create().texOffs(0, 25).mirror().addBox(0.0f, 2.0f, -1.5f, 2, 4, 2), PartPose.offsetAndRotation(3.0f, 18.0f, -2.0f, -0.1745329f, 0.0f, 0.0f));
        root.addOrReplaceChild("LegRightBackTop", CubeListBuilder.create().texOffs(30, 19).mirror().addBox(0.0f, 0.0f, -2.0f, 2, 3, 3), PartPose.offsetAndRotation(3.0f, 18.0f, 3.0f, 0.1396263f, 0.0f, 0.0f));
        root.addOrReplaceChild("LegRightBackBottom", CubeListBuilder.create().texOffs(16, 25).mirror().addBox(0.0f, 2.0f, -1.0f, 2, 4, 2), PartPose.offsetAndRotation(3.0f, 18.0f, 3.0f, -0.1745329f, 0.0f, 0.0f));
        root.addOrReplaceChild("RightBackPaw", CubeListBuilder.create().texOffs(36, 31).mirror().addBox(0.0f, 5.0f, -3.0f, 2, 1, 4), PartPose.offset(3.0f, 18.0f, 3.0f));
        root.addOrReplaceChild("LegLeftFrontTop", CubeListBuilder.create().texOffs(0, 19).mirror().addBox(-2.0f, 0.0f, -1.0f, 2, 3, 3), PartPose.offsetAndRotation(-2.0f, 18.0f, -3.0f, -0.0872665f, 0.0f, 0.0f));
        root.addOrReplaceChild("SnoutRight", CubeListBuilder.create().texOffs(48, 2).mirror().addBox(1.0f, -3.0f, -5.0f, 1, 1, 1), PartPose.offset(1.0f, 16.0f, -3.0f));
        root.addOrReplaceChild("LeftFrontPaw", CubeListBuilder.create().texOffs(0, 31).mirror().addBox(-2.0f, 5.0f, -3.0f, 2, 1, 4), PartPose.offset(-2.0f, 18.0f, -3.0f));
        root.addOrReplaceChild("LegLeftBackTop", CubeListBuilder.create().texOffs(10, 19).mirror().addBox(-2.0f, 0.0f, -2.0f, 2, 3, 3), PartPose.offsetAndRotation(-2.0f, 18.0f, 3.0f, 0.1396263f, 0.0f, 0.0f));
        root.addOrReplaceChild("LegLeftBackBottom", CubeListBuilder.create().texOffs(24, 25).mirror().addBox(-2.0f, 2.0f, -1.0f, 2, 4, 2), PartPose.offsetAndRotation(-2.0f, 18.0f, 3.0f, -0.1745329f, 0.0f, 0.0f));
        root.addOrReplaceChild("LeftBackPaw", CubeListBuilder.create().texOffs(24, 31).mirror().addBox(-2.0f, 5.0f, -3.0f, 2, 1, 4), PartPose.offset(-2.0f, 18.0f, 3.0f));
        root.addOrReplaceChild("LegLeftFrontBottom", CubeListBuilder.create().texOffs(8, 25).mirror().addBox(-2.0f, 2.0f, -0.5f, 2, 4, 2), PartPose.offsetAndRotation(-2.0f, 18.0f, -3.0f, -0.1745329f, 0.0f, 0.0f));
        root.addOrReplaceChild("TailPieceSmall", CubeListBuilder.create().texOffs(28, 36).mirror().addBox(0.0f, -0.5f, 4.0f, 1, 1, 1), PartPose.offsetAndRotation(0.0f, 16.0f, 7.0f, 0.1745329f, 0.0f, 0.0f));
        ...
        root.addOrReplaceChild("HeadPieceBottom", CubeListBuilder.create().texOffs(30, 7).mirror().addBox(-3.0f, -2.0f, -5.0f, 5, 2, 6), PartPose.offset(1.0f, 16.0f, -3.0f));
        root.addOrReplaceChild("HeadPieceTop", CubeListBuilder.create().texOffs(30, 0).mirror().addBox(-3.0f, -5.0f, -3.0f, 5, 3, 4), PartPose.offset(1.0f, 16.0f, -3.0f));
        root.addOrReplaceChild("HornRightBottom", CubeListBuilder.create().texOffs(8, 14).mirror().addBox(0.0f, -6.0f, -3.5f, 2, 3, 2), PartPose.offsetAndRotation(1.0f, 16.0f, -3.0f, -0.7853982f, 0.7853982f, 0.0f));
        root.addOrReplaceChild("HornLeftBottom", CubeListBuilder.create().texOffs(0, 14).mirror().addBox(-2.75f, -6.5f, -3.0f, 2, 3, 2), PartPose.offsetAndRotation(1.0f, 16.0f, -3.0f, -0.7853982f, -0.7853982f, 0.0f));
        root.addOrReplaceChild("HornRightTop", CubeListBuilder.create().texOffs(20, 14).mirror().addBox(0.5f, -9.0f, -3.0f, 1, 3, 1), PartPose.offsetAndRotation(1.0f, 16.0f, -3.0f, -0.7853982f, 0.7853982f, 0.0f));
        root.addOrReplaceChild("HornLeftTop", CubeListBuilder.create().texOffs(16, 14).mirror().addBox(-2.2f, -9.5f, -2.5f, 1, 3, 1), PartPose.offsetAndRotation(1.0f, 16.0f, -3.0f, -0.7853982f, -0.7853982f, 0.0f));
        ...
        root.addOrReplaceChild("SnoutLeft", CubeListBuilder.create().texOffs(48, 0).mirror().addBox(-3.0f, -3.0f, -5.0f, 1, 1, 1), PartPose.offset(1.0f, 16.0f, -3.0f));
        root.addOrReplaceChild("WingPieceLeft", CubeListBuilder.create().texOffs(4, 42).mirror().addBox(-1.0f, -2.0f, -1.0f, 1, 2, 1), PartPose.offsetAndRotation(0.0f, 17.2f, 0.0f, 0.1745329f, 0.0f, -0.1745329f));
        ...
        root.addOrReplaceChild("WingPieceRight", CubeListBuilder.create().texOffs(0, 42).mirror().addBox(-1.0f, -2.0f, 0.0f, 1, 2, 1), PartPose.offsetAndRotation(2.0f, 17.5f, -1.0f, 0.1745329f, 0.0f, 0.1745329f));
        ...
        root.addOrReplaceChild("ScaleBackHead", CubeListBuilder.create().texOffs(38, 36).mirror().addBox(-1.0f, -3.0f, 2.0f, 1, 2, 1), PartPose.offset(1.0f, 16.0f, -4.0f));
        root.addOrReplaceChild("TailPieceLarge", CubeListBuilder.create().texOffs(22, 36).mirror().addBox(0.0f, -1.0f, 2.0f, 1, 2, 2), PartPose.offsetAndRotation(0.0f, 16.0f, 7.0f, 0.1745329f, 0.0f, 0.0f));
        root.addOrReplaceChild("ScaleTailPiece", CubeListBuilder.create().texOffs(48, 36).mirror().addBox(-0.5f, -2.0f, 0.2f, 1, 1, 2), PartPose.offsetAndRotation(0.5f, 17.5f, 5.0f, 0.4537856f, 0.0f, 0.0f));
        root.addOrReplaceChild("ScaleHead", CubeListBuilder.create().texOffs(42, 36).mirror().addBox(-1.0f, -6.0f, 0.0f, 1, 2, 2), PartPose.offset(1.0f, 16.0f, -3.0f));
        root.addOrReplaceChild("ScaleTop1", CubeListBuilder.create().texOffs(48, 36).mirror().addBox(-1.0f, -6.0f, -4.0f, 1, 1, 2), PartPose.offset(1.0f, 16.0f, -2.0f));
        root.addOrReplaceChild("ScaleBackPiece1", CubeListBuilder.create().texOffs(48, 36).mirror().addBox(0.0f, -1.0f, -1.0f, 1, 1, 2), PartPose.offset(0.0f, 17.0f, 0.0f));
        root.addOrReplaceChild("ScaleBackPiece2", CubeListBuilder.create().texOffs(48, 36).mirror().addBox(0.0f, -1.0f, -1.0f, 1, 1, 2), PartPose.offset(0.0f, 17.0f, 3.0f));
        return mesh;
    }
