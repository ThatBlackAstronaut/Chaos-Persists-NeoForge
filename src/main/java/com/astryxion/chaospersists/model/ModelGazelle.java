...
public class ModelGazelle extends EntityModel<Gazelle> {
    ...
    public static MeshDefinition createMesh() {
        ...
        partdefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(12, 57).mirror().addBox(0.0f, 0.0f, 0.0f, 5, 2, 3), PartPose.offsetAndRotation(-2.5f, 8.0f, -6.0f, 2.342252f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("lfleg1", CubeListBuilder.create().texOffs(0, 31).mirror().addBox(0.0f, 0.0f, 0.0f, 2, 6, 3), PartPose.offsetAndRotation(2.0f, 6.0f, -6.0f, 0.2974289f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("lrleg2", CubeListBuilder.create().texOffs(16, 49).mirror().addBox(0.0f, 5.0f, -1.0f, 2, 2, 6), PartPose.offsetAndRotation(2.0f, 4.0f, 3.0f, 0.1858931f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("lrleg1", CubeListBuilder.create().texOffs(23, 31).mirror().addBox(0.0f, 0.0f, 0.0f, 2, 6, 3), PartPose.offset(2.0f, 4.0f, 3.0f));
        partdefinition.addOrReplaceChild("rfleg3", CubeListBuilder.create().texOffs(40, 49).mirror().addBox(0.0f, 10.0f, 6.0f, 2, 6, 2), PartPose.offsetAndRotation(-4.0f, 5.966667f, -6.0f, -0.4089647f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("rrleg2", CubeListBuilder.create().texOffs(16, 49).mirror().addBox(0.0f, 5.0f, -1.0f, 2, 2, 6), PartPose.offsetAndRotation(-4.0f, 4.0f, 3.0f, 0.1858931f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("rrleg3", CubeListBuilder.create().texOffs(32, 11).mirror().addBox(0.0f, 4.0f, 5.0f, 2, 12, 2), PartPose.offsetAndRotation(-4.0f, 3.966667f, 3.0f, -0.0743572f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("rfleg2", CubeListBuilder.create().texOffs(24, 11).mirror().addBox(0.0f, 2.0f, 2.0f, 2, 12, 2), PartPose.offsetAndRotation(-4.0f, 5.966667f, -6.0f, -0.0743572f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("lrleg4", CubeListBuilder.create().texOffs(32, 49).mirror().addBox(0.0f, 11.0f, 9.5f, 2, 6, 2), PartPose.offsetAndRotation(2.0f, 4.0f, 3.0f, -0.4089647f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(0, 49).mirror().addBox(0.0f, 0.0f, 0.0f, 4, 4, 4), PartPose.offsetAndRotation(-2.0f, 0.0f, 4.0f, 0.9666439f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("lear", CubeListBuilder.create().texOffs(18, 0).mirror().addBox(-5.0f, -3.0f, 2.0f, 3, 2, 1), PartPose.offsetAndRotation(0.0f, -9.0f, -6.0f, -0.1047198f, 1.570796f, 0.0f));
        partdefinition.addOrReplaceChild("rrleg1", CubeListBuilder.create().texOffs(23, 31).mirror().addBox(0.0f, 0.0f, 0.0f, 2, 6, 3), PartPose.offset(-4.0f, 4.0f, 3.0f));
        partdefinition.addOrReplaceChild("rfleg1", CubeListBuilder.create().texOffs(0, 31).mirror().addBox(0.0f, 0.0f, 0.0f, 2, 6, 3), PartPose.offsetAndRotation(-4.0f, 6.0f, -6.0f, 0.2974289f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("lrleg3", CubeListBuilder.create().texOffs(32, 11).mirror().addBox(0.0f, 4.0f, 5.0f, 2, 12, 2), PartPose.offsetAndRotation(2.0f, 3.966667f, 3.0f, -0.0743572f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("lfleg2", CubeListBuilder.create().texOffs(24, 11).mirror().addBox(0.0f, 2.0f, 2.0f, 2, 12, 2), PartPose.offsetAndRotation(2.0f, 5.966667f, -6.0f, -0.0743572f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("rrleg5", CubeListBuilder.create().texOffs(0, 58).mirror().addBox(-0.5f, 17.0f, 2.0f, 3, 3, 3), PartPose.offset(-4.0f, 4.0f, 3.0f));
        partdefinition.addOrReplaceChild("rrleg4", CubeListBuilder.create().texOffs(32, 49).mirror().addBox(0.0f, 11.0f, 9.5f, 2, 6, 2), PartPose.offsetAndRotation(-4.0f, 3.966667f, 3.0f, -0.4089647f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("lfleg3", CubeListBuilder.create().texOffs(40, 49).mirror().addBox(0.0f, 10.0f, 6.0f, 2, 6, 2), PartPose.offsetAndRotation(2.0f, 5.966667f, -6.0f, -0.4089647f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("rfleg4", CubeListBuilder.create().texOffs(0, 58).mirror().addBox(-0.5f, 15.0f, -1.0f, 3, 3, 3), PartPose.offset(-4.0f, 6.0f, -6.0f));
        partdefinition.addOrReplaceChild("lfleg4", CubeListBuilder.create().texOffs(0, 58).mirror().addBox(-0.5f, 15.0f, -1.0f, 3, 3, 3), PartPose.offset(2.0f, 6.0f, -6.0f));
        partdefinition.addOrReplaceChild("lrleg5", CubeListBuilder.create().texOffs(0, 58).mirror().addBox(-0.5f, 17.0f, 2.0f, 3, 3, 3), PartPose.offset(2.0f, 4.0f, 3.0f));
        partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 12).mirror().addBox(0.0f, 0.0f, 0.0f, 6, 6, 13), PartPose.offsetAndRotation(-3.0f, 2.0f, -7.0f, 0.2230717f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(0, 31).mirror().addBox(0.0f, 0.0f, 0.0f, 5, 5, 13), PartPose.offsetAndRotation(-2.5f, 6.0f, -8.0f, 1.524323f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("la3", CubeListBuilder.create().texOffs(4, 12).mirror().addBox(0.5f, -12.5f, 3.0f, 1, 5, 1), PartPose.offsetAndRotation(0.0f, -9.0f, -6.0f, -0.3346075f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("throatfluff", CubeListBuilder.create().texOffs(36, 41).mirror().addBox(0.0f, -2.0f, 0.0f, 4, 3, 5), PartPose.offsetAndRotation(-2.0f, 0.0f, -8.0f, 1.07818f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("rear", CubeListBuilder.create().texOffs(18, 0).mirror().addBox(-5.0f, -3.0f, -3.0f, 3, 2, 1), PartPose.offsetAndRotation(0.0f, -9.0f, -6.0f, 0.1047198f, 1.570796f, 0.0f));
        partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-3.0f, -3.0f, -3.0f, 6, 6, 6), PartPose.offset(0.0f, -9.0f, -6.0f));
        partdefinition.addOrReplaceChild("ra1", CubeListBuilder.create().texOffs(0, 12).mirror().addBox(-1.5f, -5.0f, 0.0f, 1, 4, 1), PartPose.offsetAndRotation(0.0f, -9.0f, -6.0f, -0.3717861f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("la1", CubeListBuilder.create().texOffs(0, 12).mirror().addBox(0.5f, -5.0f, 0.0f, 1, 4, 1), PartPose.offsetAndRotation(0.0f, -9.0f, -6.0f, -0.3717861f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("la2", CubeListBuilder.create().texOffs(0, 17).mirror().addBox(0.5f, -8.5f, -3.0f, 1, 5, 1), PartPose.offsetAndRotation(0.0f, -9.0f, -6.0f, -1.041001f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("ra2", CubeListBuilder.create().texOffs(0, 17).mirror().addBox(-1.5f, -8.5f, -3.0f, 1, 5, 1), PartPose.offsetAndRotation(0.0f, -9.0f, -6.0f, -1.041001f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("ra3", CubeListBuilder.create().texOffs(4, 12).mirror().addBox(-1.5f, -12.5f, 3.0f, 1, 5, 1), PartPose.offsetAndRotation(0.0f, -9.0f, -6.0f, -0.3346075f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(24, 0).mirror().addBox(-2.5f, 0.0f, -7.0f, 5, 3, 5), PartPose.offset(0.0f, -9.0f, -6.0f));
        partdefinition.addOrReplaceChild("mouth", CubeListBuilder.create().texOffs(28, 57).mirror().addBox(-2.0f, 2.0f, -6.0f, 4, 2, 5), PartPose.offset(0.0f, -9.0f, -6.0f));
