...
public class ModelWormLarge extends EntityModel<WormLarge> {
    ...
    private static MeshDefinition createMesh() {
        ...
        root.addOrReplaceChild("head1", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-8.0f, -8.0f, -20.0f, 16, 16, 20), PartPose.offset(0.0f, 0.0f, 10.0f));
        root.addOrReplaceChild("head2", CubeListBuilder.create().texOffs(83, 27).mirror().addBox(8.0f, -3.0f, -20.0f, 3, 6, 19), PartPose.offset(0.0f, 0.0f, 10.0f));
        root.addOrReplaceChild("head3", CubeListBuilder.create().texOffs(9, 65).mirror().addBox(-11.0f, -3.0f, -20.0f, 3, 6, 19), PartPose.offset(0.0f, 0.0f, 10.0f));
        root.addOrReplaceChild("head4", CubeListBuilder.create().texOffs(77, 0).mirror().addBox(-3.0f, -11.0f, -20.0f, 6, 3, 20), PartPose.offset(0.0f, 0.0f, 10.0f));
        root.addOrReplaceChild("head5", CubeListBuilder.create().texOffs(10, 39).mirror().addBox(-3.0f, 8.0f, -20.0f, 6, 3, 20), PartPose.offset(0.0f, 0.0f, 10.0f));
        root.addOrReplaceChild("neck1", CubeListBuilder.create().texOffs(25, 94).mirror().addBox(-6.0f, -6.0f, -36.0f, 12, 12, 36), PartPose.offsetAndRotation(0.0f, 20.0f, 33.0f, -0.6981317f, 0.0f, 0.0f));
        root.addOrReplaceChild("neck4", CubeListBuilder.create().texOffs(25, 146).mirror().addBox(-2.0f, -8.0f, -38.0f, 4, 2, 38), PartPose.offsetAndRotation(0.0f, 20.0f, 33.0f, -0.6981317f, 0.0f, 0.0f));
        root.addOrReplaceChild("neck5", CubeListBuilder.create().texOffs(125, 189).mirror().addBox(-2.0f, 6.0f, -31.0f, 4, 2, 31), PartPose.offsetAndRotation(0.0f, 20.0f, 33.0f, -0.6981317f, 0.0f, 0.0f));
        root.addOrReplaceChild("neck2", CubeListBuilder.create().texOffs(25, 189).mirror().addBox(6.0f, -2.0f, -34.0f, 2, 4, 34), PartPose.offsetAndRotation(0.0f, 20.0f, 33.0f, -0.6981317f, 0.0f, 0.0f));
        root.addOrReplaceChild("neck3", CubeListBuilder.create().texOffs(125, 147).mirror().addBox(-8.0f, -2.0f, -34.0f, 2, 4, 34), PartPose.offsetAndRotation(0.0f, 20.0f, 33.0f, -0.6981317f, 0.0f, 0.0f));
        root.addOrReplaceChild("tail1", CubeListBuilder.create().texOffs(145, 21).mirror().addBox(-4.0f, -4.0f, 0.0f, 8, 8, 24), PartPose.offset(0.0f, 20.0f, 29.0f));
        root.addOrReplaceChild("tailtip", CubeListBuilder.create().texOffs(180, 0).mirror().addBox(-1.5f, -1.5f, 0.0f, 3, 3, 12), PartPose.offsetAndRotation(0.0f, 19.5f, 52.0f, 0.3490659f, 0.0f, 0.0f));
        root.addOrReplaceChild("tail2", CubeListBuilder.create().texOffs(145, 56).mirror().addBox(4.0f, -1.0f, 2.0f, 1, 2, 14), PartPose.offset(0.0f, 20.0f, 29.0f));
        root.addOrReplaceChild("tail3", CubeListBuilder.create().texOffs(145, 90).mirror().addBox(-5.0f, -1.0f, 2.0f, 1, 2, 14), PartPose.offset(0.0f, 20.0f, 29.0f));
        root.addOrReplaceChild("tail4", CubeListBuilder.create().texOffs(145, 76).mirror().addBox(-1.0f, -5.0f, 7.0f, 2, 1, 9), PartPose.offset(0.0f, 20.0f, 29.0f));
        root.addOrReplaceChild("tooth1", CubeListBuilder.create().texOffs(0, 220).mirror().addBox(-0.5f, -0.5f, -7.0f, 1, 1, 7), PartPose.offset(0.0f, 9.0f, -10.0f));
        root.addOrReplaceChild("tooth2", CubeListBuilder.create().texOffs(0, 210).mirror().addBox(-0.5f, -0.5f, -7.0f, 1, 1, 7), PartPose.offset(0.0f, -9.0f, -10.0f));
        root.addOrReplaceChild("tooth3", CubeListBuilder.create().texOffs(0, 200).mirror().addBox(-0.5f, -0.5f, -7.0f, 1, 1, 7), PartPose.offset(9.0f, 0.0f, -10.0f));
        root.addOrReplaceChild("tooth4", CubeListBuilder.create().texOffs(0, 190).mirror().addBox(-0.5f, -0.5f, -7.0f, 1, 1, 7), PartPose.offset(-9.0f, 0.0f, -10.0f));
        root.addOrReplaceChild("tooth5", CubeListBuilder.create().texOffs(0, 180).mirror().addBox(-0.5f, -0.5f, -7.0f, 1, 1, 7), PartPose.offset(-6.0f, -6.0f, -10.0f));
        root.addOrReplaceChild("tooth6", CubeListBuilder.create().texOffs(0, 170).mirror().addBox(-0.5f, -0.5f, -7.0f, 1, 1, 7), PartPose.offset(6.0f, 6.0f, -10.0f));
        root.addOrReplaceChild("tooth7", CubeListBuilder.create().texOffs(0, 160).mirror().addBox(-0.5f, -0.5f, -7.0f, 1, 1, 7), PartPose.offset(6.0f, -6.0f, -10.0f));
        root.addOrReplaceChild("tooth8", CubeListBuilder.create().texOffs(0, 150).mirror().addBox(-0.5f, -0.5f, -7.0f, 1, 1, 7), PartPose.offset(-6.0f, 6.0f, -10.0f));
        return mesh;
    }
