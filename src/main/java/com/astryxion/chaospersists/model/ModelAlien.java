...
public class ModelAlien extends EntityModel<Alien> {
    ...
    private static MeshDefinition createMesh() {
        ...
        root.addOrReplaceChild("torso", CubeListBuilder.create().texOffs(0, 46).mirror().addBox(-4.5f, -2.0f, 0.0f, 9, 8, 10), PartPose.offsetAndRotation(0.0f, -2.5f, -8.0f, -0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("stomach", CubeListBuilder.create().texOffs(0, 27).mirror().addBox(-3.5f, -5.0f, 8.0f, 7, 6, 12), PartPose.offsetAndRotation(0.0f, -2.5f, -8.0f, -0.5585054f, 0.0f, 0.0f));
        root.addOrReplaceChild("rThigh", CubeListBuilder.create().texOffs(59, 45).mirror().addBox(-1.5f, -4.0f, -2.5f, 4, 14, 5), PartPose.offsetAndRotation(-4.5f, 7.0f, 8.0f, -0.8028515f, 0.2443461f, 0.418879f));
        root.addOrReplaceChild("lThigh", CubeListBuilder.create().texOffs(40, 45).mirror().addBox(-2.5f, -4.0f, -2.5f, 4, 14, 5), PartPose.offsetAndRotation(4.5f, 7.0f, 8.0f, -0.8028515f, -0.2443461f, -0.418879f));
        root.addOrReplaceChild("lShin", CubeListBuilder.create().texOffs(79, 49).mirror().addBox(-2.0f, 8.0f, -5.5f, 3, 3, 12), PartPose.offsetAndRotation(4.5f, 7.0f, 8.0f, -0.4014257f, -0.2443461f, -0.418879f));
        root.addOrReplaceChild("rShin", CubeListBuilder.create().texOffs(79, 33).mirror().addBox(-1.0f, 8.0f, -5.5f, 3, 3, 12), PartPose.offsetAndRotation(-4.5f, 7.0f, 8.0f, -0.4014257f, 0.2443461f, 0.418879f));
        root.addOrReplaceChild("lShin1", CubeListBuilder.create().texOffs(113, 40).mirror().addBox(-1.5f, 5.5f, 9.0f, 2, 9, 2), PartPose.offsetAndRotation(4.5f, 7.0f, 8.0f, -0.8028515f, -0.2443461f, -0.418879f));
        root.addOrReplaceChild("rShin1", CubeListBuilder.create().texOffs(113, 53).mirror().addBox(-0.5f, 5.5f, 9.0f, 2, 9, 2), PartPose.offsetAndRotation(-4.5f, 7.0f, 8.0f, -0.8028515f, 0.2443461f, 0.418879f));
        root.addOrReplaceChild("lFoot", CubeListBuilder.create().texOffs(110, 24).mirror().addBox(5.0f, 15.0f, -8.0f, 2, 2, 6), PartPose.offsetAndRotation(4.5f, 7.0f, 8.0f, 0.0f, -0.2443461f, 0.0f));
        root.addOrReplaceChild("rFoot", CubeListBuilder.create().texOffs(95, 24).mirror().addBox(-7.0f, 15.0f, -8.0f, 2, 2, 6), PartPose.offsetAndRotation(-4.5f, 7.0f, 8.0f, 0.0f, 0.2443461f, 0.0f));
        root.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(23, 86).mirror().addBox(-2.0f, -2.0f, -4.0f, 4, 6, 5), PartPose.offsetAndRotation(0.0f, -2.5f, -8.0f, -0.1919862f, 0.0f, 0.0f));
        root.addOrReplaceChild("fan", CubeListBuilder.create().texOffs(149, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offset(0.0f, -7.0f, -10.0f));
        root.addOrReplaceChild("tail2", CubeListBuilder.create().texOffs(85, 66).mirror().addBox(-2.0f, -1.5f, 0.0f, 4, 4, 11), PartPose.offsetAndRotation(0.0f, 9.5f, 20.5f, -0.3141593f, 0.0f, 0.0f));
        root.addOrReplaceChild("tail3", CubeListBuilder.create().texOffs(118, 66).mirror().addBox(-1.5f, -1.5f, 0.0f, 3, 3, 11), PartPose.offsetAndRotation(0.0f, 13.5f, 30.5f, -0.2094395f, 0.0f, 0.0f));
        root.addOrReplaceChild("tail4", CubeListBuilder.create().texOffs(149, 66).mirror().addBox(-1.0f, -1.0f, 0.0f, 2, 2, 11), PartPose.offsetAndRotation(0.0f, 15.5f, 40.5f, -0.1396263f, 0.0f, 0.0f));
        root.addOrReplaceChild("tail5", CubeListBuilder.create().texOffs(178, 66).mirror().addBox(-0.5f, -0.5f, 0.0f, 1, 1, 11), PartPose.offsetAndRotation(0.0f, 17.5f, 50.5f, -0.0523599f, 0.0f, 0.0f));
        root.addOrReplaceChild("tail1", CubeListBuilder.create().texOffs(50, 66).mirror().addBox(-2.0f, -2.5f, 0.0f, 4, 4, 11), PartPose.offsetAndRotation(0.0f, 6.5f, 10.5f, -0.4014257f, 0.0f, 0.0f));
        root.addOrReplaceChild("fanl1", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, 0.2617994f));
        root.addOrReplaceChild("fanr1", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, -0.2617994f));
        root.addOrReplaceChild("fanl2", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, 0.5235988f));
        root.addOrReplaceChild("fanr2", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, -0.5235988f));
        root.addOrReplaceChild("fanl3", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, 0.7853982f));
        root.addOrReplaceChild("fanr3", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, -0.7853982f));
        root.addOrReplaceChild("fanl4", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, 1.047198f));
        root.addOrReplaceChild("fanr4", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, -1.047198f));
        root.addOrReplaceChild("fanl5", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, 1.308997f));
        root.addOrReplaceChild("fanr5", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, -1.308997f));
        root.addOrReplaceChild("fanl6", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, 1.570796f));
        root.addOrReplaceChild("fanr6", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, -1.570796f));
        root.addOrReplaceChild("spike4", CubeListBuilder.create().texOffs(178, 66).mirror().addBox(-0.5f, -0.5f, 0.0f, 1, 1, 11), PartPose.offsetAndRotation(0.0f, 16.0f, 41.0f, -0.0523599f, 0.5235988f, 0.0f));
        root.addOrReplaceChild("spike5", CubeListBuilder.create().texOffs(178, 66).mirror().addBox(-0.5f, -0.5f, 0.0f, 1, 1, 11), PartPose.offsetAndRotation(0.0f, 16.0f, 41.0f, -0.0523599f, -0.5759587f, 0.0f));
        root.addOrReplaceChild("spike3", CubeListBuilder.create().texOffs(178, 66).mirror().addBox(-0.5f, -0.5f, 0.0f, 1, 1, 11), PartPose.offsetAndRotation(0.0f, 13.5f, 30.5f, 0.3141593f, 0.0f, 0.0f));
        root.addOrReplaceChild("fanl7", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, 1.832596f));
        root.addOrReplaceChild("fanr7", CubeListBuilder.create().texOffs(130, 10).mirror().addBox(-3.0f, -24.0f, 0.0f, 6, 24, 1), PartPose.offsetAndRotation(0.0f, -7.0f, -10.0f, 0.0f, 0.0f, -1.832596f));
        root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(200, 0).mirror().addBox(-3.0f, -4.0f, -7.0f, 6, 7, 8), PartPose.offset(0.0f, -3.0f, -11.0f));
        root.addOrReplaceChild("head1", CubeListBuilder.create().texOffs(200, 18).mirror().addBox(-2.5f, -2.0f, -15.0f, 5, 2, 8), PartPose.offset(0.0f, -3.0f, -11.0f));
        root.addOrReplaceChild("jaw1", CubeListBuilder.create().texOffs(200, 43).mirror().addBox(-2.0f, -1.0f, -7.0f, 4, 2, 8), PartPose.offset(0.0f, -2.0f, -19.0f));
        root.addOrReplaceChild("head2", CubeListBuilder.create().texOffs(200, 31).mirror().addBox(-2.0f, -2.0f, -22.0f, 4, 2, 7), PartPose.offset(0.0f, -3.0f, -11.0f));
        root.addOrReplaceChild("jaw2", CubeListBuilder.create().texOffs(200, 56).mirror().addBox(-1.5f, -1.0f, -13.0f, 3, 2, 6), PartPose.offset(0.0f, -2.0f, -19.0f));
        root.addOrReplaceChild("fang1", CubeListBuilder.create().texOffs(42, 0).mirror().addBox(1.0f, 0.0f, -20.0f, 1, 5, 1), PartPose.offset(0.0f, -3.0f, -11.0f));
        root.addOrReplaceChild("fang2", CubeListBuilder.create().texOffs(50, 0).mirror().addBox(-2.0f, 0.0f, -20.0f, 1, 5, 1), PartPose.offset(0.0f, -3.0f, -11.0f));
        root.addOrReplaceChild("fang3", CubeListBuilder.create().texOffs(60, 0).mirror().addBox(1.0f, 0.0f, -14.0f, 1, 3, 1), PartPose.offset(0.0f, -3.0f, -11.0f));
        root.addOrReplaceChild("fang4", CubeListBuilder.create().texOffs(69, 0).mirror().addBox(-2.0f, 0.0f, -14.0f, 1, 3, 1), PartPose.offset(0.0f, -3.0f, -11.0f));
        root.addOrReplaceChild("spike2", CubeListBuilder.create().texOffs(178, 66).mirror().addBox(-0.5f, -0.5f, 0.0f, 1, 1, 11), PartPose.offsetAndRotation(0.0f, 9.5f, 20.5f, 0.3141593f, 0.0f, 0.0f));
        root.addOrReplaceChild("spike1", CubeListBuilder.create().texOffs(178, 66).mirror().addBox(-0.5f, -1.5f, 0.0f, 1, 1, 11), PartPose.offsetAndRotation(0.0f, 6.5f, 10.5f, 0.3141593f, 0.0f, 0.0f));
        root.addOrReplaceChild("arml1", CubeListBuilder.create().texOffs(50, 98).mirror().addBox(0.0f, 0.0f, -2.0f, 11, 3, 4), PartPose.offsetAndRotation(2.0f, -1.0f, -6.0f, 0.0f, -0.5235988f, 0.1745329f));
        root.addOrReplaceChild("armr1", CubeListBuilder.create().texOffs(49, 88).mirror().addBox(0.0f, 0.0f, -2.0f, 11, 3, 4), PartPose.offsetAndRotation(-3.0f, -1.0f, -6.0f, 0.0f, -2.617994f, -0.1745329f));
        root.addOrReplaceChild("arml2", CubeListBuilder.create().texOffs(41, 107).mirror().addBox(0.0f, -1.0f, -1.0f, 15, 3, 3), PartPose.offsetAndRotation(11.0f, 2.0f, -1.0f, 0.0f, 0.8552113f, 0.0f));
        root.addOrReplaceChild("armr2", CubeListBuilder.create().texOffs(42, 115).mirror().addBox(0.0f, -1.0f, -2.0f, 15, 3, 3), PartPose.offsetAndRotation(-11.0f, 2.0f, -1.0f, 0.0f, 2.268928f, 0.0f));
        root.addOrReplaceChild("clawr1", CubeListBuilder.create().texOffs(100, 85).mirror().addBox(-0.5f, -1.0f, -6.0f, 1, 1, 6), PartPose.offsetAndRotation(-21.0f, 2.0f, -12.0f, -0.1745329f, 0.4363323f, 0.0f));
        root.addOrReplaceChild("clawr2", CubeListBuilder.create().texOffs(100, 94).mirror().addBox(0.0f, 0.0f, -10.0f, 1, 1, 10), PartPose.offsetAndRotation(-21.0f, 2.0f, -12.0f, 0.0f, 0.8726646f, 0.0f));
        root.addOrReplaceChild("clawr3", CubeListBuilder.create().texOffs(100, 107).mirror().addBox(0.0f, 1.0f, -6.0f, 1, 1, 6), PartPose.offsetAndRotation(-21.0f, 2.0f, -12.0f, 0.1745329f, 0.4363323f, 0.0f));
        root.addOrReplaceChild("clawl2", CubeListBuilder.create().texOffs(130, 94).mirror().addBox(0.0f, 0.0f, 0.0f, 1, 1, 10), PartPose.offsetAndRotation(21.0f, 2.0f, -12.0f, 0.0f, 2.268928f, 0.0f));
        root.addOrReplaceChild("clawl3", CubeListBuilder.create().texOffs(130, 109).mirror().addBox(0.0f, 1.0f, 0.0f, 1, 1, 6), PartPose.offsetAndRotation(21.0f, 2.0f, -12.0f, -0.1745329f, 2.70526f, 0.0f));
        root.addOrReplaceChild("clawl1", CubeListBuilder.create().texOffs(130, 83).mirror().addBox(0.0f, -1.0f, 0.0f, 1, 1, 6), PartPose.offsetAndRotation(21.0f, 2.0f, -12.0f, 0.1745329f, 2.70526f, 0.0f));
        return mesh;
    }
