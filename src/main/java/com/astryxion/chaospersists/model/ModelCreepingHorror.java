...
public class ModelCreepingHorror extends EntityModel<CreepingHorror> {
    ...
    public static MeshDefinition createMesh() {
        ...
        partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 30).mirror().addBox(-4.0f, -5.0f, -4.0f, 8, 8, 8), PartPose.offset(0.0f, 20.0f, 0.0f));
        partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(65, 0).mirror().addBox(-1.0f, -1.0f, -1.0f, 16, 2, 2), PartPose.offsetAndRotation(4.0f, 18.0f, -2.0f, 0.0f, 0.5759587f, 0.1919862f));
        partdefinition.addOrReplaceChild("leg1part2", CubeListBuilder.create().texOffs(37, 5).mirror().addBox(13.01f, -1.01f, -1.0f, 2, 5, 2), PartPose.offsetAndRotation(4.0f, 18.0f, -2.0f, 0.0f, 0.5759587f, 0.1919862f));
        partdefinition.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(65, 0).mirror().addBox(-1.0f, -1.0f, -1.0f, 16, 2, 2), PartPose.offsetAndRotation(4.0f, 18.0f, 2.0f, 0.0f, -0.5759587f, 0.1919862f));
        partdefinition.addOrReplaceChild("leg2part2", CubeListBuilder.create().texOffs(37, 5).mirror().addBox(13.01f, -1.01f, -1.0f, 2, 5, 2), PartPose.offsetAndRotation(4.0f, 18.0f, 2.0f, 0.0f, -0.5759587f, 0.1919862f));
        partdefinition.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(28, 0).mirror().addBox(-15.0f, -1.0f, -1.0f, 16, 2, 2), PartPose.offsetAndRotation(-4.0f, 18.0f, -2.0f, 0.0f, -0.5759587f, -0.1919862f));
        partdefinition.addOrReplaceChild("leg3part2", CubeListBuilder.create().texOffs(28, 5).mirror().addBox(-15.01f, -1.01f, -1.0f, 2, 5, 2), PartPose.offsetAndRotation(-4.0f, 18.0f, -2.0f, 0.0f, -0.5759587f, -0.1919862f));
        partdefinition.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(28, 0).mirror().addBox(-15.0f, -1.0f, -1.0f, 16, 2, 2), PartPose.offsetAndRotation(-4.0f, 18.0f, 2.0f, 0.0f, 0.5759587f, -0.1919862f));
        partdefinition.addOrReplaceChild("leg4part2", CubeListBuilder.create().texOffs(28, 5).mirror().addBox(-15.01f, -1.01f, -1.0f, 2, 5, 2), PartPose.offsetAndRotation(-4.0f, 18.0f, 2.0f, 0.0f, 0.5759587f, -0.1919862f));
        partdefinition.addOrReplaceChild("tailseg1", CubeListBuilder.create().texOffs(0, 13).mirror().addBox(-2.0f, -1.0f, 0.0f, 4, 2, 7), PartPose.offsetAndRotation(0.0f, 17.0f, 3.0f, -0.5576792f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("tailseg2", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-1.0f, 3.0f, 7.0f, 2, 1, 11), PartPose.offsetAndRotation(0.0f, 17.0f, 3.0f, -0.0349066f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("tailseg3", CubeListBuilder.create().texOffs(0, 24).mirror().addBox(-1.5f, 1.0f, 6.0f, 3, 2, 2), PartPose.offsetAndRotation(0.0f, 17.0f, 3.0f, -0.2230717f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("pincer1", CubeListBuilder.create().texOffs(26, 30).mirror().addBox(-0.5f, -0.5f, -5.0f, 1, 1, 5), PartPose.offsetAndRotation(-3.0f, 19.0f, -3.0f, 0.0f, -0.2230717f, 0.0f));
        partdefinition.addOrReplaceChild("pincer1part2", CubeListBuilder.create().texOffs(26, 30).mirror().addBox(-0.5f, -0.5f, -5.01f, 2, 1, 0), PartPose.offsetAndRotation(-3.0f, 19.0f, -3.0f, 0.0f, -0.2230717f, 0.0f));
        partdefinition.addOrReplaceChild("pincer2", CubeListBuilder.create().texOffs(26, 30).mirror().addBox(-0.5f, -0.5f, -5.0f, 1, 1, 5), PartPose.offsetAndRotation(3.0f, 19.0f, -3.0f, 0.0f, 0.2230705f, 0.0f));
        partdefinition.addOrReplaceChild("pincer2part2", CubeListBuilder.create().texOffs(26, 28).mirror().addBox(-1.5f, -0.5f, -5.01f, 2, 1, 0), PartPose.offsetAndRotation(3.0f, 19.0f, -3.0f, 0.0f, 0.2230705f, 0.0f));
        partdefinition.addOrReplaceChild("spike1", CubeListBuilder.create().texOffs(26, 13).mirror().addBox(-0.5f, -0.5f, 0.0f, 1, 1, 6), PartPose.offsetAndRotation(-3.0f, 16.0f, -2.0f, 0.7063936f, -0.2602503f, 0.0f));
        partdefinition.addOrReplaceChild("spike2", CubeListBuilder.create().texOffs(26, 13).mirror().addBox(-0.5f, -0.5f, 0.0f, 1, 1, 6), PartPose.offsetAndRotation(-1.0f, 16.0f, 1.0f, 0.7063936f, -0.111544f, 0.0f));
        partdefinition.addOrReplaceChild("spike3", CubeListBuilder.create().texOffs(26, 13).mirror().addBox(-0.5f, -0.5f, 0.0f, 1, 1, 6), PartPose.offsetAndRotation(1.0f, 16.0f, 1.0f, 0.7063936f, 0.1115358f, 0.0f));
        partdefinition.addOrReplaceChild("spike4", CubeListBuilder.create().texOffs(26, 13).mirror().addBox(-0.5f, -0.5f, 0.0f, 1, 1, 6), PartPose.offsetAndRotation(3.0f, 16.0f, -2.0f, 0.7063936f, 0.260246f, 0.0f));
        partdefinition.addOrReplaceChild("spike5", CubeListBuilder.create().texOffs(26, 13).mirror().addBox(-0.5f, -0.5f, 0.0f, 1, 1, 6), PartPose.offsetAndRotation(0.0f, 16.0f, -3.0f, 0.7063936f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("insides1", CubeListBuilder.create().texOffs(0, 30).mirror().addBox(-2.0f, -3.0f, -3.0f, 4, 4, 0), PartPose.offset(0.0f, 20.0f, 0.0f));
        partdefinition.addOrReplaceChild("insides2", CubeListBuilder.create().texOffs(-1, 29).mirror().addBox(-2.0f, -3.0f, -4.0f, 4, 0, 1), PartPose.offset(0.0f, 20.0f, 0.0f));
        partdefinition.addOrReplaceChild("insides3", CubeListBuilder.create().texOffs(-1, 29).mirror().addBox(-2.0f, 1.0f, -4.0f, 4, 0, 1), PartPose.offset(0.0f, 20.0f, 0.0f));
        partdefinition.addOrReplaceChild("insides4", CubeListBuilder.create().texOffs(0, 29).mirror().addBox(-2.0f, -3.0f, -4.0f, 0, 4, 1), PartPose.offset(0.0f, 20.0f, 0.0f));
        partdefinition.addOrReplaceChild("insides5", CubeListBuilder.create().texOffs(0, 29).mirror().addBox(2.0f, -3.0f, -4.0f, 0, 4, 1), PartPose.offset(0.0f, 20.0f, 0.0f));
