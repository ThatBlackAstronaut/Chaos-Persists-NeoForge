...
public class ModelSeaMonster extends EntityModel<SeaMonster> {
    ...
    public static MeshDefinition createMesh() {
        ...
        partdefinition.addOrReplaceChild("TailTip", CubeListBuilder.create().texOffs(158, 36).mirror().addBox(-1.0f, -1.0f, 0.0f, 2, 2, 6), PartPose.offsetAndRotation(0.0f, 16.0f, 70.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("TailBase", CubeListBuilder.create().texOffs(68, 64).mirror().addBox(-7.0f, -7.0f, 0.0f, 14, 14, 12), PartPose.offsetAndRotation(0.0f, 16.0f, 26.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(74, 90).mirror().addBox(-6.0f, -6.0f, 0.0f, 12, 12, 8), PartPose.offsetAndRotation(0.0f, 16.0f, 38.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Tail3", CubeListBuilder.create().texOffs(78, 110).mirror().addBox(-5.0f, -5.0f, 0.0f, 10, 10, 6), PartPose.offsetAndRotation(0.0f, 16.0f, 46.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("BodyBack", CubeListBuilder.create().texOffs(62, 32).mirror().addBox(-8.0f, -8.0f, 0.0f, 16, 16, 16), PartPose.offsetAndRotation(0.0f, 16.0f, 10.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Neck6", CubeListBuilder.create().texOffs(20, 28).mirror().addBox(-2.0f, -6.0f, -2.0f, 4, 6, 4), PartPose.offsetAndRotation(0.0f, -21.0f, -25.0f, 1.22173f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("BodyFront", CubeListBuilder.create().texOffs(62, 0).mirror().addBox(-8.0f, -8.0f, -16.0f, 16, 16, 16), PartPose.offsetAndRotation(0.0f, 16.0f, 10.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("NeckBase", CubeListBuilder.create().texOffs(8, 96).mirror().addBox(-5.0f, -10.0f, -5.0f, 10, 10, 10), PartPose.offsetAndRotation(0.0f, 12.0f, -2.0f, 0.7853982f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Neck2", CubeListBuilder.create().texOffs(14, 78).mirror().addBox(-3.0f, -10.0f, -4.0f, 6, 10, 8), PartPose.offsetAndRotation(0.0f, 6.0f, -9.0f, 0.6981317f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Neck3", CubeListBuilder.create().texOffs(16, 62).mirror().addBox(-3.0f, -10.0f, -3.0f, 6, 10, 6), PartPose.offsetAndRotation(0.0f, -1.0f, -15.0f, 0.5235988f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Neck4", CubeListBuilder.create().texOffs(20, 48).mirror().addBox(-2.0f, -10.0f, -2.0f, 4, 10, 4), PartPose.offsetAndRotation(0.0f, -9.0f, -20.0f, 0.2617994f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Neck5", CubeListBuilder.create().texOffs(20, 38).mirror().addBox(-2.0f, -6.0f, -2.0f, 4, 6, 4), PartPose.offsetAndRotation(0.0f, -17.6f, -22.0f, 0.7853982f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("BottomJaw", CubeListBuilder.create().texOffs(10, 0).mirror().addBox(-4.0f, 0.0f, -10.0f, 8, 3, 10), PartPose.offsetAndRotation(0.0f, -23.0f, -29.0f, 0.1745329f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("FinBackRight", CubeListBuilder.create().texOffs(132, 95).mirror().addBox(-8.0f, 0.0f, 0.0f, 8, 1, 16), PartPose.offsetAndRotation(-7.0f, 16.0f, 16.0f, -0.5235988f, -0.6981317f, 0.0f));
        partdefinition.addOrReplaceChild("FinBackLeft", CubeListBuilder.create().texOffs(132, 61).mirror().addBox(0.0f, 0.0f, 0.0f, 8, 1, 16), PartPose.offsetAndRotation(7.0f, 16.0f, 16.0f, -0.5235988f, 0.6981317f, 0.0f));
        partdefinition.addOrReplaceChild("FinFrontLeft", CubeListBuilder.create().texOffs(132, 44).mirror().addBox(0.0f, 0.0f, 0.0f, 8, 1, 16), PartPose.offsetAndRotation(7.0f, 16.0f, -1.0f, -0.5235988f, 0.6981317f, 0.0f));
        partdefinition.addOrReplaceChild("FinFrontRight", CubeListBuilder.create().texOffs(132, 78).mirror().addBox(-8.0f, 0.0f, 0.0f, 8, 1, 16), PartPose.offsetAndRotation(-7.0f, 16.0f, -1.0f, -0.5235988f, -0.6981317f, 0.0f));
        partdefinition.addOrReplaceChild("Tail4", CubeListBuilder.create().texOffs(152, 0).mirror().addBox(-4.0f, -4.0f, 0.0f, 8, 8, 6), PartPose.offsetAndRotation(0.0f, 16.0f, 52.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Tail5", CubeListBuilder.create().texOffs(154, 14).mirror().addBox(-3.0f, -3.0f, 0.0f, 6, 6, 6), PartPose.offsetAndRotation(0.0f, 16.0f, 58.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("Tail6", CubeListBuilder.create().texOffs(156, 26).mirror().addBox(-2.0f, -2.0f, 0.0f, 4, 4, 6), PartPose.offsetAndRotation(0.0f, 16.0f, 64.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("TopJaw", CubeListBuilder.create().texOffs(10, 13).mirror().addBox(-4.0f, -4.0f, -10.0f, 8, 4, 10), PartPose.offsetAndRotation(0.0f, -23.0f, -29.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("RightEye", CubeListBuilder.create().texOffs(46, 16).mirror().addBox(-3.0f, -6.0f, -5.0f, 2, 2, 1), PartPose.offsetAndRotation(0.0f, -23.0f, -29.0f, 0.0f, 0.0f, 0.0f));
        partdefinition.addOrReplaceChild("LeftEye", CubeListBuilder.create().texOffs(4, 16).mirror().addBox(1.0f, -6.0f, -5.0f, 2, 2, 1), PartPose.offsetAndRotation(0.0f, -23.0f, -29.0f, 0.0f, 0.0f, 0.0f));
